...
void GGS_typeDomainMap::
modifier_setMDomainForKey (C_Compiler & inLexique,                        const GGS_typeDomain & inValue,
  ...
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    ...
    if (node == NULL) {
      ...
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setMDomainForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.mDomain = inValue ;
    }
  }
}
...
GGS_typeFormalArgumentsList::cElement * GGS_typeFormalArgumentsList::
...
const GGS_luint  * GGS_typeFormalArgumentsList::cEnumerator::_mVariableIndex (LOCATION_ARGS) const {
  ...
  return & (((cElement *) mNextEnumeratedObject)->mVariableIndex) ;
}
...
const GGS_luint  * GGS_typeFormalArgumentsList::cEnumerator::_mVariableBitSize (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mVariableBitSize) ;
}
...
const GGS_luint  * GGS_typeFormalArgumentsList::cEnumerator::_mLowBound (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mLowBound) ;
}
...
const GGS_luint  * GGS_typeFormalArgumentsList::cEnumerator::_mHighBound (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mHighBound) ;
}
...
GGS_typeActualArgumentsList::cElement * GGS_typeActualArgumentsList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
void GGS_typeTableVariablesBool::
modifier_setMVariableDescriptorForKey (C_Compiler & inLexique,                        const GGS_typeVariableDescriptor & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setMVariableDescriptorForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.mVariableDescriptor = inValue ;
    }
  }
}
...
void GGS_typeTableFormules::
modifier_setAListeArgsFormelsBoolForKey (C_Compiler & inLexique,                        const GGS_typeFormalArgumentsList & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setAListeArgsFormelsBoolForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.aListeArgsFormelsBool = inValue ;
    }
  }
}
...
void GGS_typeTableFormules::
modifier_setABDDForKey (C_Compiler & inLexique,                        const GGS_extern_bdd& inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
    ...
    if (node == NULL) {
      C_String errorMessage ;
      errorMessage << "the '" << inKey << "' key does not exist when calling 'setABDDForKey' modifier" ;
      inLexique.onTheFlyRunTimeError (errorMessage COMMA_THERE) ;
    }else{
      node->mInfo.aBDD = inValue ;
    }
  }
}
...
GGS_typeListeCalculs::cElement * GGS_typeListeCalculs::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
const GGS_typeCalcul  * GGS_typeListeCalculs::cEnumerator::_mCalcul (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mCalcul) ;
}
...
void routine_verifierNombreArgumentsBool (C_Compiler & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (260)))._operator_strictInf (var_cas_t2.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (260)))).isBuiltAndTrue ()) {
    var_cas_positionFinListe.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much actual arguments") COMMA_SOURCE_FILE_AT_LINE (261)) ;
    ...
    var_cas_positionFinListe.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more actual arguments missing") COMMA_SOURCE_FILE_AT_LINE (263)) ;
  }
  {
    GGS_typeFormalArgumentsList::cEnumerator enumerator_7836 (var_cas_t1, true) ;
    const GGS_typeFormalArgumentsList::cElement * operand_7836 = NULL ;
    GGS_typeActualArgumentsList::cEnumerator enumerator_7907 (var_cas_t2, true) ;
    const GGS_typeActualArgumentsList::cElement * operand_7907 = NULL ;
    while (((operand_7836 = enumerator_7836.nextObject ()))
        && ((operand_7907 = enumerator_7907.nextObject ()))) {
      macroValidPointer (operand_7836) ;
      macroValidPointer (operand_7907) ;
      if (((operand_7836->mVariableBitSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)))._operator_isEqual (operand_7907->mVariableBitSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)))).isBuiltAndTrue ()) {
        if (((operand_7836->mLowBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)))._operator_isEqual (operand_7907->mLowBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)))).isBuiltAndTrue ()) {
          if (((operand_7836->mHighBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)))._operator_isEqual (operand_7907->mHighBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)))).isBuiltAndTrue ()) {
          }else{
            operand_7907->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual high bound is different the formal one") COMMA_SOURCE_FILE_AT_LINE (271)) ;
          }
        }else{
          operand_7907->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual low bound is different the formal one") COMMA_SOURCE_FILE_AT_LINE (274)) ;
        }
      }else{
        operand_7907->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual dimension is different from the formal one") COMMA_SOURCE_FILE_AT_LINE (277)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildFormalArgsList (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_typeVariableDescriptor _var_9286 = var_cas_inVariableDescriptor ; // CAST instruction
    if (_var_9286.getPtr () != NULL) {
      macroValidPointer (_var_9286.getPtr ()) ;
      if (dynamic_cast <cPtr_typeDirectVariable *> (_var_9286.getPtr ()) != NULL) {
        const GGS_typeDirectVariable var_cas_v (_var_9286.getPtr ()) ;
        var_cas_ioFormalArgsList._addAssign_operation (var_cas_v.reader_mIndex (_inLexique COMMA_SOURCE_FILE_AT_LINE (291)), var_cas_v.reader_mBitSize (_inLexique COMMA_SOURCE_FILE_AT_LINE (291)), var_cas_v.reader_mLowBound (_inLexique COMMA_SOURCE_FILE_AT_LINE (291)), var_cas_v.reader_mHighBound (_inLexique COMMA_SOURCE_FILE_AT_LINE (291))) ;
      }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_9286.getPtr ()) != NULL) {
        const GGS_typeRecordVariable var_cas_r (_var_9286.getPtr ()) ;
        {
          GGS_typeTableVariablesBool::cEnumerator enumerator_9079 (var_cas_r.reader_mMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)), true) ;
          const GGS_typeTableVariablesBool::cElement * operand_9079 = NULL ;
          while (((operand_9079 = enumerator_9079.nextObject ()))) {
            macroValidPointer (operand_9079) ;
            ::routine_buildFormalArgsList (_inLexique,  operand_9079->mInfo.mVariableDescriptor,  var_cas_ioFormalArgsList,  var_cas_inErrorLocation COMMA_SOURCE_FILE_AT_LINE (293)) ;
          }
        }
      }else{
      ...
      var_cas_inErrorLocation._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 2, & typeid (* (_var_9286.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (296)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildActualArgsList (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_typeTableVariablesBool::cEnumerator enumerator_9540 (var_cas_inDomainMap, true) ;
    const GGS_typeTableVariablesBool::cElement * operand_9540 = NULL ;
    while (((operand_9540 = enumerator_9540.nextObject ()))) {
      macroValidPointer (operand_9540) ;
      { const GGS_typeVariableDescriptor _var_9930 = operand_9540->mInfo.mVariableDescriptor ; // CAST instruction
        if (_var_9930.getPtr () != NULL) {
          macroValidPointer (_var_9930.getPtr ()) ;
          if (dynamic_cast <cPtr_typeDirectVariable *> (_var_9930.getPtr ()) != NULL) {
            const GGS_typeDirectVariable var_cas_v (_var_9930.getPtr ()) ;
            var_cas_ioActualArgsList._addAssign_operation (var_cas_v.reader_mIndex (_inLexique COMMA_SOURCE_FILE_AT_LINE (310)), var_cas_v.reader_mBitSize (_inLexique COMMA_SOURCE_FILE_AT_LINE (310)), var_cas_v.reader_mLowBound (_inLexique COMMA_SOURCE_FILE_AT_LINE (310)), var_cas_v.reader_mHighBound (_inLexique COMMA_SOURCE_FILE_AT_LINE (310)), var_cas_inErrorLocation) ;
          }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_9930.getPtr ()) != NULL) {
            const GGS_typeRecordVariable var_cas_r (_var_9930.getPtr ()) ;
            ::routine_buildActualArgsList (_inLexique,  var_cas_r.reader_mMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (312)),  var_cas_ioActualArgsList,  var_cas_inErrorLocation COMMA_SOURCE_FILE_AT_LINE (311)) ;
          }else{
          const castBranchDescriptorType _castBranchDescriptor [2] = {
            {& typeid (cPtr_typeDirectVariable), true},
            {& typeid (cPtr_typeRecordVariable), true}
          } ;
          var_cas_inErrorLocation._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 2, & typeid (* (_var_9930.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (313)) ;
          }
        }
      }
    }
