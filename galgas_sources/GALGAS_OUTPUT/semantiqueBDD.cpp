...
AC_galgas_map_elementEx * GGS_typeDomainMap::
...
void GGS_typeDomainMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
...
elementOf_GGG_typeFormalArgumentsList::
elementOf_GGG_typeFormalArgumentsList (const GGG_luint  *argument_0,
                                const GGG_luint  *argument_1,
                                const GGG_luint  *argument_2,
                                const GGG_luint  *argument_3 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeFormalArgumentsList *) NULL ;
  mVariableIndex = argument_0 ;
  retain (mVariableIndex COMMA_HERE) ;
  mVariableBitSize = argument_1 ;
  retain (mVariableBitSize COMMA_HERE) ;
  mLowBound = argument_2 ;
  retain (mLowBound COMMA_HERE) ;
  mHighBound = argument_3 ;
  retain (mHighBound COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_typeFormalArgumentsList::
~elementOf_GGG_typeFormalArgumentsList (void) {
  macroRelease (mVariableIndex, this) ;
  macroRelease (mVariableBitSize, this) ;
  macroRelease (mLowBound, this) ;
  macroRelease (mHighBound, this) ;
}
...
elementOf_GGG_typeActualArgumentsList::
elementOf_GGG_typeActualArgumentsList (const GGG_luint  *argument_0,
                                const GGG_luint  *argument_1,
                                const GGG_luint  *argument_2,
                                const GGG_luint  *argument_3,
                                const GGG_location  *argument_4 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeActualArgumentsList *) NULL ;
  mVariableIndex = argument_0 ;
  retain (mVariableIndex COMMA_HERE) ;
  mVariableBitSize = argument_1 ;
  retain (mVariableBitSize COMMA_HERE) ;
...
elementOf_GGG_typeActualArgumentsList::
~elementOf_GGG_typeActualArgumentsList (void) {
  macroRelease (mVariableIndex, this) ;
  macroRelease (mVariableBitSize, this) ;
  macroRelease (mLowBound, this) ;
  macroRelease (mHighBound, this) ;
...
void GGS_typeTableVariablesBool::methode_searchKeyGetIndex (C_Lexique & inLexique,
  ...
  if (info == NULL) {
    ...
    outParameter0 = info->mInfo.mVariableDescriptor ;
    outIndex = GGS_luint (GGS_uint (true, (uint32) info->mEntryIndex), inKey COMMA_HERE) ;
  }
}
...
AC_galgas_map_elementEx * GGS_typeTableFormules::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeTableFormules::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
elementOf_GGG_typeListeCalculs::
elementOf_GGG_typeListeCalculs (const GGG_typeCalcul  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_object (THERE) {
  mNextItem = (elementOf_GGG_typeListeCalculs *) NULL ;
  aCalcul = argument_0 ;
  retain (aCalcul COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

elementOf_GGG_typeListeCalculs::
~elementOf_GGG_typeListeCalculs (void) {
  macroRelease (aCalcul, this) ;
}
    ...
    if (((operand_7824->mVariableBitSize.reader_value ()) == (operand_7913->mVariableBitSize.reader_value ())).isBuiltAndTrue ()) {
      if (((operand_7824->mLowBound.reader_value ()) == (operand_7913->mLowBound.reader_value ())).isBuiltAndTrue ()) {
        if (((operand_7824->mHighBound.reader_value ()) == (operand_7913->mHighBound.reader_value ())).isBuiltAndTrue ()) {
            ...
            operand_7913->mErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "the actual high bound is different the formal one")) ;
        }
      }else{
          operand_7913->mErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "the actual low bound is different the formal one")) ;
      }
    }else{
        operand_7913->mErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "the actual dimension is different from the formal one")) ;
    }
