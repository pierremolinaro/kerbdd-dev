...
GGS_string GGS_typeFormalArgumentsList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeActualArgumentsList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeListeCalculs::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
void routine_verifierNombreArgumentsBool (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (258))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (258)))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (260))) > (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (260)))).isBuiltAndTrue ()) {
  ...
  GGS_typeFormalArgumentsList::element_type * operand_7785 = var_cas_t1.firstObject () ;
  GGS_typeActualArgumentsList::element_type * operand_7874 = var_cas_t2.firstObject () ;
  while ((operand_7785 != NULL)
      && (operand_7874 != NULL)) {
    macroValidPointer (operand_7785) ;
    macroValidPointer (operand_7874) ;
    if (((operand_7785->mVariableBitSize.reader_value (_inLexique SOURCE_FILE_AT_LINE (265))) == (operand_7874->mVariableBitSize.reader_value (_inLexique SOURCE_FILE_AT_LINE (265)))).isBuiltAndTrue ()) {
      if (((operand_7785->mLowBound.reader_value (_inLexique SOURCE_FILE_AT_LINE (266))) == (operand_7874->mLowBound.reader_value (_inLexique SOURCE_FILE_AT_LINE (266)))).isBuiltAndTrue ()) {
        if (((operand_7785->mHighBound.reader_value (_inLexique SOURCE_FILE_AT_LINE (267))) == (operand_7874->mHighBound.reader_value (_inLexique SOURCE_FILE_AT_LINE (267)))).isBuiltAndTrue ()) {
        }else{
            operand_7874->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual high bound is different the formal one") SOURCE_FILE_AT_LINE (269)) ;
        }
      }else{
          operand_7874->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual low bound is different the formal one") SOURCE_FILE_AT_LINE (272)) ;
      }
    }else{
        operand_7874->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual dimension is different from the formal one") SOURCE_FILE_AT_LINE (275)) ;
    }
    operand_7785 = operand_7785->nextObject () ;
...
void routine_buildFormalArgsList (C_Lexique & _inLexique,
  ...
  if (var_cas_inVariableDescriptor.isBuilt ()) {
    if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_inVariableDescriptor.getPtr ()) != NULL) {
      cPtr_typeDirectVariable * operand_8763 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_inVariableDescriptor.getPtr ()) ;
      macroValidPointer (operand_8763) ; 
      var_cas_ioFormalArgsList.addAssign_operation (operand_8763->mIndex, operand_8763->mBitSize, operand_8763->mLowBound, operand_8763->mHighBound) ;
    }else if (dynamic_cast <cPtr_typeRecordVariable *> (var_cas_inVariableDescriptor.getPtr ()) != NULL) {
      cPtr_typeRecordVariable * operand_8949 = dynamic_cast <cPtr_typeRecordVariable *> (var_cas_inVariableDescriptor.getPtr ()) ;
      macroValidPointer (operand_8949) ; 
      GGS_typeTableVariablesBool::element_type * operand_9046 = operand_8949->mMap.firstObject () ;
      while ((operand_9046 != NULL)) {
        macroValidPointer (operand_9046) ;
        ::routine_buildFormalArgsList (_inLexique,  operand_9046->mInfo.mVariableDescriptor,  var_cas_ioFormalArgsList,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (292)) ;
        operand_9046 = operand_9046->nextObject () ;
      }
    }else{ // Else part
        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a variable was expected here ; I found ")) + (var_cas_inVariableDescriptor.reader_variableDescriptorErrorMessage (_inLexique SOURCE_FILE_AT_LINE (295)))) SOURCE_FILE_AT_LINE (295)) ;
    }
  }
}
...
void routine_buildActualArgsList (C_Lexique & _inLexique,
                                ...
                                const GGS_location  & var_cas_inErrorLocation COMMA_UNUSED_LOCATION_ARGS) {
  GGS_typeTableVariablesBool::element_type * operand_9621 = var_cas_inDomainMap.firstObject () ;
  while ((operand_9621 != NULL)) {
    macroValidPointer (operand_9621) ;
    if (operand_9621->mInfo.mVariableDescriptor.isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectVariable *> (operand_9621->mInfo.mVariableDescriptor.getPtr ()) != NULL) {
        cPtr_typeDirectVariable * operand_9730 = dynamic_cast <cPtr_typeDirectVariable *> (operand_9621->mInfo.mVariableDescriptor.getPtr ()) ;
        macroValidPointer (operand_9730) ; 
        var_cas_ioActualArgsList.addAssign_operation (operand_9730->mIndex, operand_9730->mBitSize, operand_9730->mLowBound, operand_9730->mHighBound, var_cas_inErrorLocation) ;
      }else if (dynamic_cast <cPtr_typeRecordVariable *> (operand_9621->mInfo.mVariableDescriptor.getPtr ()) != NULL) {
        cPtr_typeRecordVariable * operand_9937 = dynamic_cast <cPtr_typeRecordVariable *> (operand_9621->mInfo.mVariableDescriptor.getPtr ()) ;
        macroValidPointer (operand_9937) ; 
        ::routine_buildActualArgsList (_inLexique,  operand_9937->mMap,  var_cas_ioActualArgsList,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (311)) ;
      }else{ // Else part
          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a variable was expected here ; I found ")) + (operand_9621->mInfo.mVariableDescriptor.reader_variableDescriptorErrorMessage (_inLexique SOURCE_FILE_AT_LINE (314)))) SOURCE_FILE_AT_LINE (314)) ;
      }
    }
    operand_9621 = operand_9621->nextObject () ;
  }
}
