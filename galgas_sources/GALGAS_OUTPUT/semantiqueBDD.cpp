...
void routine_verifierNombreArgumentsBool (C_Compiler & inLexique,
  ...
  #endif
  if (((var_cas_t1.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (260))).operator_strictInf (var_cas_t2.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (260)))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_t1.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (262))).operator_strictSup (var_cas_t2.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (262)))).isBuiltAndTrue ()) {
  ...
  }
  {
    ...
    while (((operand_7967 = enumerator_7967.nextObject ()))
      ...
      if (((operand_7967->mVariableBitSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (267))).operator_isEqual (operand_8048->mVariableBitSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (267)))).isBuiltAndTrue ()) {
        if (((operand_7967->mLowBound.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (268))).operator_isEqual (operand_8048->mLowBound.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (268)))).isBuiltAndTrue ()) {
          if (((operand_7967->mHighBound.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (269))).operator_isEqual (operand_8048->mHighBound.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (269)))).isBuiltAndTrue ()) {
          }else{
