...
void routine_verifierNombreArgumentsBool (C_Compiler & _inLexique,
  ...
  GGS_typeFormalArgumentsList::cEnumerator enumerator_7875 (var_cas_t1, true) ;
  const GGS_typeFormalArgumentsList::cElement * operand_7875 = NULL ;
  GGS_typeActualArgumentsList::cEnumerator enumerator_7946 (var_cas_t2, true) ;
  const GGS_typeActualArgumentsList::cElement * operand_7946 = NULL ;
  while (((operand_7875 = (GGS_typeFormalArgumentsList::cElement *) enumerator_7875.nextObject ()))
      && ((operand_7946 = enumerator_7946.nextObject ()))) {
    macroValidPointer (operand_7875) ;
    macroValidPointer (operand_7946) ;
    if (((operand_7875->mVariableBitSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)))._operator_isEqual (operand_7946->mVariableBitSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)))).isBuiltAndTrue ()) {
      if (((operand_7875->mLowBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)))._operator_isEqual (operand_7946->mLowBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)))).isBuiltAndTrue ()) {
        if (((operand_7875->mHighBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)))._operator_isEqual (operand_7946->mHighBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)))).isBuiltAndTrue ()) {
        }else{
          operand_7946->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual high bound is different the formal one") COMMA_SOURCE_FILE_AT_LINE (271)) ;
        }
      }else{
        operand_7946->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual low bound is different the formal one") COMMA_SOURCE_FILE_AT_LINE (274)) ;
      }
    }else{
      operand_7946->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual dimension is different from the formal one") COMMA_SOURCE_FILE_AT_LINE (277)) ;
    }
  }
  enumerator_7875.reset () ;
  enumerator_7946.reset () ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildFormalArgsList (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_typeVariableDescriptor _var_9323 = var_cas_inVariableDescriptor ; // CAST instruction
    if (_var_9323.getPtr () != NULL) {
      macroValidPointer (_var_9323.getPtr ()) ;
      if (dynamic_cast <cPtr_typeDirectVariable *> (_var_9323.getPtr ()) != NULL) {
        const GGS_typeDirectVariable var_cas_v (_var_9323.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_9323.getPtr ()) != NULL) {
        const GGS_typeRecordVariable var_cas_r (_var_9323.getPtr ()) ;
        GGS_typeTableVariablesBool::cEnumerator enumerator_9117 (var_cas_r.reader_mMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)), true) ;
        const GGS_typeTableVariablesBool::cElement * operand_9117 = NULL ;
        while (((operand_9117 = (GGS_typeTableVariablesBool::cElement *) enumerator_9117.nextObject ()))) {
          macroValidPointer (operand_9117) ;
          ::routine_buildFormalArgsList (_inLexique,  operand_9117->mInfo.mVariableDescriptor,  var_cas_ioFormalArgsList,  var_cas_inErrorLocation COMMA_SOURCE_FILE_AT_LINE (293)) ;
        }
        enumerator_9117.reset () ;
      }else{
      ...
      var_cas_inErrorLocation._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 2, & typeid (* (_var_9323.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (296)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildActualArgsList (C_Compiler & _inLexique,
  ...
  #endif
  GGS_typeTableVariablesBool::cEnumerator enumerator_9577 (var_cas_inDomainMap, true) ;
  const GGS_typeTableVariablesBool::cElement * operand_9577 = NULL ;
  while (((operand_9577 = (GGS_typeTableVariablesBool::cElement *) enumerator_9577.nextObject ()))) {
    macroValidPointer (operand_9577) ;
    { const GGS_typeVariableDescriptor _var_10327 = operand_9577->mInfo.mVariableDescriptor ; // CAST instruction
      if (_var_10327.getPtr () != NULL) {
        macroValidPointer (_var_10327.getPtr ()) ;
        if (dynamic_cast <cPtr_typeDirectVariable *> (_var_10327.getPtr ()) != NULL) {
          const GGS_typeDirectVariable var_cas_v (_var_10327.getPtr ()) ;
        ...
        }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_10327.getPtr ()) != NULL) {
          const GGS_typeRecordVariable var_cas_r (_var_10327.getPtr ()) ;
        ...
        var_cas_inErrorLocation._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 2, & typeid (* (_var_10327.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (317)) ;
        }
      }
    }
  }
  enumerator_9577.reset () ;
  #ifdef DEBUG_TRACE_ENABLED
