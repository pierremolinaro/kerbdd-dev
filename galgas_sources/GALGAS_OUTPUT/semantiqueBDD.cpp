    ...
    if (((operand_7746->mVariableBitSize.reader_value (_inLexique SOURCE_FILE_AT_LINE (264))) == (operand_7835->mVariableBitSize.reader_value (_inLexique SOURCE_FILE_AT_LINE (264)))).isBuiltAndTrue ()) {
      if (((operand_7746->mLowBound.reader_value (_inLexique SOURCE_FILE_AT_LINE (265))) == (operand_7835->mLowBound.reader_value (_inLexique SOURCE_FILE_AT_LINE (265)))).isBuiltAndTrue ()) {
        if (((operand_7746->mHighBound.reader_value (_inLexique SOURCE_FILE_AT_LINE (266))) == (operand_7835->mHighBound.reader_value (_inLexique SOURCE_FILE_AT_LINE (266)))).isBuiltAndTrue ()) {
            ...
            operand_7835->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual high bound is different the formal one") SOURCE_FILE_AT_LINE (268)) ;
        }
      }else{
          operand_7835->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual low bound is different the formal one") SOURCE_FILE_AT_LINE (271)) ;
      }
    }else{
        operand_7835->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual dimension is different from the formal one") SOURCE_FILE_AT_LINE (274)) ;
    }
    ...
    if (operand_9582->mInfo.mVariableDescriptor.isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectVariable *> (operand_9582->mInfo.mVariableDescriptor.getPtr ()) != NULL) {
        ...
        ::routine_buildActualArgsList (_inLexique,  operand_9898->mMap,  var_cas_ioActualArgsList,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (310)) ;
          ...
          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a variable was expected here ; I found ")) + (operand_9582->mInfo.mVariableDescriptor.reader_variableDescriptorErrorMessage (_inLexique SOURCE_FILE_AT_LINE (313)))) SOURCE_FILE_AT_LINE (313)) ;
      }
    }
