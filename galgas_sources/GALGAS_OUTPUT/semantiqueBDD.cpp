...
GGS_typeFormalArgumentsList::GGS_typeFormalArgumentsList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_typeActualArgumentsList::GGS_typeActualArgumentsList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_typeListeCalculs::GGS_typeListeCalculs (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
void routine_verifierNombreArgumentsBool (C_Compiler & _inLexique,
  ...
  }
  {
    ...
    while (((operand_7836 = (GGS_typeFormalArgumentsList::cElement *) enumerator_7836.nextObject ()))
    ...
    if (_var_9286.getPtr () != NULL) {
      ...
      if (dynamic_cast <cPtr_typeDirectVariable *> (_var_9286.getPtr ()) != NULL) {
        ...
        const GGS_typeRecordVariable var_cas_r (_var_9286.getPtr ()) ;
        {
          ...
          while (((operand_9079 = (GGS_typeTableVariablesBool::cElement *) enumerator_9079.nextObject ()))) {
...
void routine_buildActualArgsList (C_Compiler & _inLexique,
  ...
  #endif
  {
    ...
    while (((operand_9540 = (GGS_typeTableVariablesBool::cElement *) enumerator_9540.nextObject ()))) {
