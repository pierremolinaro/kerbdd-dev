...
void routine_verifierNombreArgumentsBool (C_Compiler & _inLexique,
  ...
  const GGS_typeFormalArgumentsList::element_type * operand_7876 = _var_7876.firstObject () ;
  const GGS_typeActualArgumentsList _var_7947 = var_cas_t2 ;
  const GGS_typeActualArgumentsList::element_type * operand_7947 = _var_7947.firstObject () ;
...
void routine_buildFormalArgsList (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_typeVariableDescriptor _var_9324 = var_cas_inVariableDescriptor ; // CAST instruction
    if (_var_9324.getPtr () != NULL) {
      macroValidPointer (_var_9324.getPtr ()) ;
      if (dynamic_cast <cPtr_typeDirectVariable *> (_var_9324.getPtr ()) != NULL) {
        const GGS_typeDirectVariable var_cas_v (_var_9324.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_9324.getPtr ()) != NULL) {
        const GGS_typeRecordVariable var_cas_r (_var_9324.getPtr ()) ;
        const GGS_typeTableVariablesBool _var_9118 = var_cas_r.reader_mMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)) ;
        const GGS_typeTableVariablesBool::element_type * operand_9118 = _var_9118.firstObject () ;
        while ((operand_9118 != NULL)) {
          macroValidPointer (operand_9118) ;
          ::routine_buildFormalArgsList (_inLexique,  operand_9118->mInfo.mVariableDescriptor,  var_cas_ioFormalArgsList,  var_cas_inErrorLocation COMMA_SOURCE_FILE_AT_LINE (294)) ;
          operand_9118 = operand_9118->nextObject () ;
        }
      }else{
      ...
      var_cas_inErrorLocation._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 2, & typeid (* (_var_9324.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (297)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildActualArgsList (C_Compiler & _inLexique,
  ...
  #endif
  const GGS_typeTableVariablesBool _var_9578 = var_cas_inDomainMap ;
  const GGS_typeTableVariablesBool::element_type * operand_9578 = _var_9578.firstObject () ;
  while ((operand_9578 != NULL)) {
    macroValidPointer (operand_9578) ;
    { const GGS_typeVariableDescriptor _var_10328 = operand_9578->mInfo.mVariableDescriptor ; // CAST instruction
      if (_var_10328.getPtr () != NULL) {
        macroValidPointer (_var_10328.getPtr ()) ;
        if (dynamic_cast <cPtr_typeDirectVariable *> (_var_10328.getPtr ()) != NULL) {
          const GGS_typeDirectVariable var_cas_v (_var_10328.getPtr ()) ;
        ...
        }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_10328.getPtr ()) != NULL) {
          const GGS_typeRecordVariable var_cas_r (_var_10328.getPtr ()) ;
        ...
        var_cas_inErrorLocation._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 2, & typeid (* (_var_10328.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (318)) ;
        }
      }
    }
    operand_9578 = operand_9578->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
