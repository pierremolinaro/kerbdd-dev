...
void routine_verifierNombreArgumentsBool (C_Compiler & _inLexique,
  ...
  const GGS_typeFormalArgumentsList _var_7875 = var_cas_t1 ;
  const GGS_typeFormalArgumentsList::element_type * operand_7875 = _var_7875.firstObject () ;
  const GGS_typeActualArgumentsList _var_7946 = var_cas_t2 ;
  const GGS_typeActualArgumentsList::element_type * operand_7946 = _var_7946.firstObject () ;
  while ((operand_7875 != NULL)
      && (operand_7946 != NULL)) {
    ...
    operand_7875 = operand_7875->nextObject () ;
    operand_7946 = operand_7946->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
  ...
  { const GGS_typeVariableDescriptor _var_9323 = var_cas_inVariableDescriptor ; // CAST instruction
    if (_var_9323.getPtr () != NULL) {
      ...
      if (dynamic_cast <cPtr_typeDirectVariable *> (_var_9323.getPtr ()) != NULL) {
        ...
        const GGS_typeTableVariablesBool _var_9117 = var_cas_r.reader_mMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)) ;
        const GGS_typeTableVariablesBool::element_type * operand_9117 = _var_9117.firstObject () ;
        while ((operand_9117 != NULL)) {
          ...
          operand_9117 = operand_9117->nextObject () ;
        }
      }else{
...
void routine_buildActualArgsList (C_Compiler & _inLexique,
  ...
  #endif
  const GGS_typeTableVariablesBool _var_9577 = var_cas_inDomainMap ;
  const GGS_typeTableVariablesBool::element_type * operand_9577 = _var_9577.firstObject () ;
  while ((operand_9577 != NULL)) {
    ...
    operand_9577 = operand_9577->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
