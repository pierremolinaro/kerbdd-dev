      ...
      if (((operand_7943->mVariableBitSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)))._operator_isEqual (operand_8024->mVariableBitSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)))).isBuiltAndTrue ()) {
        if (((operand_7943->mLowBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)))._operator_isEqual (operand_8024->mLowBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)))).isBuiltAndTrue ()) {
          if (((operand_7943->mHighBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)))._operator_isEqual (operand_8024->mHighBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)))).isBuiltAndTrue ()) {
            ...
            operand_8024->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual high bound is different the formal one") COMMA_SOURCE_FILE_AT_LINE (272)) ;
          }
        }else{
          operand_8024->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual low bound is different the formal one") COMMA_SOURCE_FILE_AT_LINE (275)) ;
        }
      }else{
        operand_8024->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual dimension is different from the formal one") COMMA_SOURCE_FILE_AT_LINE (278)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
