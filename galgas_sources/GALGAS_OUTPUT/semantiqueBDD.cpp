...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mDomain.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
void GGS_typeDomainMap::
modifier_setMDomainForKey (C_Compiler & inLexique,
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mVariableDescriptor.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
void GGS_typeTableVariablesBool::
modifier_setMVariableDescriptorForKey (C_Compiler & inLexique,
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.aListeArgsFormelsBool.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.aBDD.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
void GGS_typeTableFormules::
modifier_setAListeArgsFormelsBoolForKey (C_Compiler & inLexique,
...
void GGS_typeTableFormules::
modifier_setABDDForKey (C_Compiler & inLexique,
...
void routine_verifierNombreArgumentsBool (C_Compiler & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (260)))._operator_strictInf (var_cas_t2.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (260)))).isBuiltAndTrue ()) {
    var_cas_positionFinListe.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("too much actual arguments") COMMA_SOURCE_FILE_AT_LINE (262)) ;
    ...
    var_cas_positionFinListe.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("one or more actual arguments missing") COMMA_SOURCE_FILE_AT_LINE (264)) ;
  }
  {
    ...
    GGS_typeActualArgumentsList::cEnumerator enumerator_8024 (var_cas_t2, true) ;
    const GGS_typeActualArgumentsList::cElement * operand_8024 = NULL ;
    while (((operand_7943 = enumerator_7943.nextObject ()))
        && ((operand_8024 = enumerator_8024.nextObject ()))) {
      macroValidPointer (operand_7943) ;
      macroValidPointer (operand_8024) ;
      if (((operand_7943->mVariableBitSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)))._operator_isEqual (operand_8024->mVariableBitSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)))).isBuiltAndTrue ()) {
        if (((operand_7943->mLowBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)))._operator_isEqual (operand_8024->mLowBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)))).isBuiltAndTrue ()) {
          if (((operand_7943->mHighBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)))._operator_isEqual (operand_8024->mHighBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)))).isBuiltAndTrue ()) {
          }else{
            operand_8024->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the actual high bound is different the formal one") COMMA_SOURCE_FILE_AT_LINE (272)) ;
          }
        }else{
          operand_8024->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the actual low bound is different the formal one") COMMA_SOURCE_FILE_AT_LINE (275)) ;
        }
      }else{
        operand_8024->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the actual dimension is different from the formal one") COMMA_SOURCE_FILE_AT_LINE (278)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildFormalArgsList (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_typeVariableDescriptor _var_9396 = var_cas_inVariableDescriptor ; // CAST instruction
    if (_var_9396.getPtr () != NULL) {
      macroValidPointer (_var_9396.getPtr ()) ;
      if (dynamic_cast <cPtr_typeDirectVariable *> (_var_9396.getPtr ()) != NULL) {
        const GGS_typeDirectVariable var_cas_v (_var_9396.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_9396.getPtr ()) != NULL) {
        const GGS_typeRecordVariable var_cas_r (_var_9396.getPtr ()) ;
        {
          GGS_typeTableVariablesBool::cEnumerator enumerator_9185 (var_cas_r.reader_mMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)), true) ;
          const GGS_typeTableVariablesBool::cElement * operand_9185 = NULL ;
          while (((operand_9185 = enumerator_9185.nextObject ()))) {
            macroValidPointer (operand_9185) ;
            ::routine_buildFormalArgsList (_inLexique,  operand_9185->mInfo.mVariableDescriptor,  var_cas_ioFormalArgsList,  var_cas_inErrorLocation COMMA_SOURCE_FILE_AT_LINE (294)) ;
          }
        }
      }else{
      ...
      var_cas_inErrorLocation._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 2, & typeid (* (_var_9396.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (297)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildActualArgsList (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_typeTableVariablesBool::cEnumerator enumerator_9656 (var_cas_inDomainMap, true) ;
    const GGS_typeTableVariablesBool::cElement * operand_9656 = NULL ;
    while (((operand_9656 = enumerator_9656.nextObject ()))) {
      macroValidPointer (operand_9656) ;
      { const GGS_typeVariableDescriptor _var_10042 = operand_9656->mInfo.mVariableDescriptor ; // CAST instruction
        if (_var_10042.getPtr () != NULL) {
          macroValidPointer (_var_10042.getPtr ()) ;
          if (dynamic_cast <cPtr_typeDirectVariable *> (_var_10042.getPtr ()) != NULL) {
            const GGS_typeDirectVariable var_cas_v (_var_10042.getPtr ()) ;
          ...
          }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_10042.getPtr ()) != NULL) {
            const GGS_typeRecordVariable var_cas_r (_var_10042.getPtr ()) ;
            ::routine_buildActualArgsList (_inLexique,  var_cas_r.reader_mMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (312)),  var_cas_ioActualArgsList,  var_cas_inErrorLocation COMMA_SOURCE_FILE_AT_LINE (312)) ;
          }else{
          const castBranchDescriptorType _castBranchDescriptor [2] = {
            {& typeid (cPtr_typeDirectVariable), true},
            {& typeid (cPtr_typeRecordVariable), true}
          } ;
          var_cas_inErrorLocation._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 2, & typeid (* (_var_10042.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (314)) ;
          }
        }
      }
    }
