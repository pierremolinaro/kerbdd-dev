...
void routine_verifierNombreArgumentsBool (C_Compiler & _inLexique,
  ...
  {
    GGS_typeFormalArgumentsList::cEnumerator enumerator_7940 (var_cas_t1, true) ;
    const GGS_typeFormalArgumentsList::cElement * operand_7940 = NULL ;
    GGS_typeActualArgumentsList::cEnumerator enumerator_8011 (var_cas_t2, true) ;
    const GGS_typeActualArgumentsList::cElement * operand_8011 = NULL ;
    while (((operand_7940 = enumerator_7940.nextObject ()))
        && ((operand_8011 = enumerator_8011.nextObject ()))) {
      macroValidPointer (operand_7940) ;
      macroValidPointer (operand_8011) ;
      if (((operand_7940->mVariableBitSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)))._operator_isEqual (operand_8011->mVariableBitSize.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)))).isBuiltAndTrue ()) {
        if (((operand_7940->mLowBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)))._operator_isEqual (operand_8011->mLowBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)))).isBuiltAndTrue ()) {
          if (((operand_7940->mHighBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)))._operator_isEqual (operand_8011->mHighBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)))).isBuiltAndTrue ()) {
          }else{
            operand_8011->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual high bound is different the formal one") COMMA_SOURCE_FILE_AT_LINE (271)) ;
          }
        }else{
          operand_8011->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual low bound is different the formal one") COMMA_SOURCE_FILE_AT_LINE (274)) ;
        }
      }else{
        operand_8011->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual dimension is different from the formal one") COMMA_SOURCE_FILE_AT_LINE (277)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildFormalArgsList (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_typeVariableDescriptor _var_9390 = var_cas_inVariableDescriptor ; // CAST instruction
    if (_var_9390.getPtr () != NULL) {
      macroValidPointer (_var_9390.getPtr ()) ;
      if (dynamic_cast <cPtr_typeDirectVariable *> (_var_9390.getPtr ()) != NULL) {
        const GGS_typeDirectVariable var_cas_v (_var_9390.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_9390.getPtr ()) != NULL) {
        const GGS_typeRecordVariable var_cas_r (_var_9390.getPtr ()) ;
        {
          GGS_typeTableVariablesBool::cEnumerator enumerator_9183 (var_cas_r.reader_mMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)), true) ;
          const GGS_typeTableVariablesBool::cElement * operand_9183 = NULL ;
          while (((operand_9183 = enumerator_9183.nextObject ()))) {
            macroValidPointer (operand_9183) ;
            ::routine_buildFormalArgsList (_inLexique,  operand_9183->mInfo.mVariableDescriptor,  var_cas_ioFormalArgsList,  var_cas_inErrorLocation COMMA_SOURCE_FILE_AT_LINE (293)) ;
          }
        }
      }else{
      ...
      var_cas_inErrorLocation._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 2, & typeid (* (_var_9390.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (296)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildActualArgsList (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_typeTableVariablesBool::cEnumerator enumerator_9644 (var_cas_inDomainMap, true) ;
    const GGS_typeTableVariablesBool::cElement * operand_9644 = NULL ;
    while (((operand_9644 = enumerator_9644.nextObject ()))) {
      macroValidPointer (operand_9644) ;
      { const GGS_typeVariableDescriptor _var_10034 = operand_9644->mInfo.mVariableDescriptor ; // CAST instruction
        if (_var_10034.getPtr () != NULL) {
          macroValidPointer (_var_10034.getPtr ()) ;
          if (dynamic_cast <cPtr_typeDirectVariable *> (_var_10034.getPtr ()) != NULL) {
            const GGS_typeDirectVariable var_cas_v (_var_10034.getPtr ()) ;
          ...
          }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_10034.getPtr ()) != NULL) {
            const GGS_typeRecordVariable var_cas_r (_var_10034.getPtr ()) ;
          ...
          var_cas_inErrorLocation._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 2, & typeid (* (_var_10034.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (313)) ;
          }
        }
      }
    }
