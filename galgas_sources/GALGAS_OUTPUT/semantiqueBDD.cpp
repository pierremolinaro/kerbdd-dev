...
new_element (void * inKey, void * inInfo) {
  ...
  M_assert (reinterpret_cast <e_typeDomainMap *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
...
new_element (void * inKey, void * inInfo) {
  M_assert (reinterpret_cast <GGS_lstring *> (inKey) != NULL, "Dynamic cast error", 0, 0) ;
  M_assert (reinterpret_cast <e_typeTableFormules *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_element * p = NULL ;
  GGS_lstring * key = (GGS_lstring *) inKey ;
...
void searchKey_typeTableFormules (C_lexique & inLexique,
                                ...
                                GGS_bdd  * outParameter1,
                                GGS_luint * outIndex) {
  const char * kErrorMessage [] = {"La formule '%' n'a pas ete declaree",
                                   NULL} ;
  ioMap.searchElement (inLexique,
                       kErrorMessage,
                       inKey,
...
void insertKey_typeTableFormules (C_lexique & lexique_var_,
                                ...
                                const GGS_bdd& inParameter1,
                                GGS_luint * outIndex) {
  const char * kErrorMessage [] = {"La formule '%' a deja ete declaree",
                                   NULL} ;
  ioMap.insertElement (lexique_var_,
                       kErrorMessage,
                       inKey,
...
//---------------------------------------------------------------------------*
//                                                                           *
//                      class 'typeFormuleQuelqueSoit'                       *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_typeFormuleQuelqueSoit::cPtr_typeFormuleQuelqueSoit (const GGS_typeFormalArgumentsList & argument_0,
                                const GGS_typeFormule & argument_1,
                                const GGS_bdd& argument_2)
...
bool cPtr_typeFormuleQuelqueSoit::isBuilt (void) const {
...
//---------------------------------------------------------------------------*
//                                                                           *
//                GALGAS class 'GGS_typeFormuleQuelqueSoit'                  *
//                                                                           *
//---------------------------------------------------------------------------*

#ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
  cPtr_typeFormuleQuelqueSoit * GGS_typeFormuleQuelqueSoit::
    constructor_new (const GGS_typeFormalArgumentsList & argument_0,
                                const GGS_typeFormule & argument_1,
                                const GGS_bdd& argument_2) {
    cPtr_typeFormuleQuelqueSoit * ptr_ = (cPtr_typeFormuleQuelqueSoit *) NULL ;
    macroMyNew (ptr_, cPtr_typeFormuleQuelqueSoit (argument_0,
                                argument_1,
                                argument_2)) ;
    return ptr_ ;
  }
...
//---------------------------------------------------------------------------*
//                                                                           *
//                      class 'typeDimensionnerCache'                        *
//                                                                           *
//---------------------------------------------------------------------------*

cPtr_typeDimensionnerCache::cPtr_typeDimensionnerCache (const GGS_luint & argument_0)
:aDimensionCache (argument_0) {
}

//---------------------------------------------------------------------------*

bool cPtr_typeDimensionnerCache::isBuilt (void) const {
  return aDimensionCache.isBuilt () ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//                 GALGAS class 'GGS_typeDimensionnerCache'                  *
//                                                                           *
//---------------------------------------------------------------------------*

#ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
  cPtr_typeDimensionnerCache * GGS_typeDimensionnerCache::
    constructor_new (const GGS_luint & argument_0) {
    cPtr_typeDimensionnerCache * ptr_ = (cPtr_typeDimensionnerCache *) NULL ;
    macroMyNew (ptr_, cPtr_typeDimensionnerCache (argument_0)) ;
    return ptr_ ;
  }
#endif
...
void routine_verifierNombreArgumentsBool (C_lexique & lexique_var_,
  ...
  GGS_typeFormalArgumentsList::element_type * operand_8145 = var_cas_t1.getFirstItem () ;
  GGS_typeActualArgumentsList::element_type * operand_8225 = var_cas_t2.getFirstItem () ;
  while ((operand_8145 != NULL) && (operand_8225 != NULL)) {
    macroValidPointer (operand_8145) ;
    macroValidPointer (operand_8225) ;
    if (((operand_8145->mVariableBitSize.reader_value ()) == (operand_8225->mVariableBitSize.reader_value ())).isBuiltAndTrue ()) {
      if (((operand_8145->mLowBound.reader_value ()) == (operand_8225->mLowBound.reader_value ())).isBuiltAndTrue ()) {
        if (((operand_8145->mHighBound.reader_value ()) == (operand_8225->mHighBound.reader_value ())).isBuiltAndTrue ()) {
        }else{
            operand_8225->mErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "the actual high bound is different the formal one")) ;
        }
      }else{
          operand_8225->mErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "the actual low bound is different the formal one")) ;
      }
    }else{
        operand_8225->mErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "the actual dimension is different from the formal one")) ;
    }
    operand_8145 = operand_8145->getNextItem () ;
    operand_8225 = operand_8225->getNextItem () ;
  }
}
