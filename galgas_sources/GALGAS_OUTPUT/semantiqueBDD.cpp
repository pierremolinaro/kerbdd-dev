...
void routine_verifierNombreArgumentsBool (C_Lexique & _inLexique,
  ...
  GGS_typeFormalArgumentsList::element_type * operand_7753 = var_cas_t1.firstObject () ;
  GGS_typeActualArgumentsList::element_type * operand_7842 = var_cas_t2.firstObject () ;
  while ((operand_7753 != NULL)
      && (operand_7842 != NULL)) {
    macroValidPointer (operand_7753) ;
    macroValidPointer (operand_7842) ;
    if (((operand_7753->mVariableBitSize.reader_value (_inLexique SOURCE_FILE_AT_LINE (264))) == (operand_7842->mVariableBitSize.reader_value (_inLexique SOURCE_FILE_AT_LINE (264)))).isBuiltAndTrue ()) {
      if (((operand_7753->mLowBound.reader_value (_inLexique SOURCE_FILE_AT_LINE (265))) == (operand_7842->mLowBound.reader_value (_inLexique SOURCE_FILE_AT_LINE (265)))).isBuiltAndTrue ()) {
        if (((operand_7753->mHighBound.reader_value (_inLexique SOURCE_FILE_AT_LINE (266))) == (operand_7842->mHighBound.reader_value (_inLexique SOURCE_FILE_AT_LINE (266)))).isBuiltAndTrue ()) {
        }else{
            operand_7842->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual high bound is different the formal one") SOURCE_FILE_AT_LINE (268)) ;
        }
      }else{
          operand_7842->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual low bound is different the formal one") SOURCE_FILE_AT_LINE (271)) ;
      }
    }else{
        operand_7842->mErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the actual dimension is different from the formal one") SOURCE_FILE_AT_LINE (274)) ;
    }
    operand_7753 = operand_7753->nextObject () ;
    operand_7842 = operand_7842->nextObject () ;
  }
}
...
void routine_buildFormalArgsList (C_Lexique & _inLexique,
  ...
  if (var_cas_inVariableDescriptor.isBuilt ()) {
    if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_inVariableDescriptor.getPtr ()) != NULL) {
      cPtr_typeDirectVariable * operand_8731 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_inVariableDescriptor.getPtr ()) ;
      macroValidPointer (operand_8731) ; 
      var_cas_ioFormalArgsList.addAssign_operation (operand_8731->mIndex, operand_8731->mBitSize, operand_8731->mLowBound, operand_8731->mHighBound) ;
    }else if (dynamic_cast <cPtr_typeRecordVariable *> (var_cas_inVariableDescriptor.getPtr ()) != NULL) {
      cPtr_typeRecordVariable * operand_8917 = dynamic_cast <cPtr_typeRecordVariable *> (var_cas_inVariableDescriptor.getPtr ()) ;
      macroValidPointer (operand_8917) ; 
      GGS_typeTableVariablesBool::element_type * operand_9014 = operand_8917->mMap.firstObject () ;
      while ((operand_9014 != NULL)) {
        macroValidPointer (operand_9014) ;
        ::routine_buildFormalArgsList (_inLexique,  operand_9014->mInfo.mVariableDescriptor,  var_cas_ioFormalArgsList,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (291)) ;
        operand_9014 = operand_9014->nextObject () ;
      }
    }else{ // Else part
...
void routine_buildActualArgsList (C_Lexique & _inLexique,
                                ...
                                const GGS_location  & var_cas_inErrorLocation COMMA_UNUSED_LOCATION_ARGS) {
  GGS_typeTableVariablesBool::element_type * operand_9589 = var_cas_inDomainMap.firstObject () ;
  while ((operand_9589 != NULL)) {
    macroValidPointer (operand_9589) ;
    if (operand_9589->mInfo.mVariableDescriptor.isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectVariable *> (operand_9589->mInfo.mVariableDescriptor.getPtr ()) != NULL) {
        cPtr_typeDirectVariable * operand_9698 = dynamic_cast <cPtr_typeDirectVariable *> (operand_9589->mInfo.mVariableDescriptor.getPtr ()) ;
        macroValidPointer (operand_9698) ; 
        var_cas_ioActualArgsList.addAssign_operation (operand_9698->mIndex, operand_9698->mBitSize, operand_9698->mLowBound, operand_9698->mHighBound, var_cas_inErrorLocation) ;
      }else if (dynamic_cast <cPtr_typeRecordVariable *> (operand_9589->mInfo.mVariableDescriptor.getPtr ()) != NULL) {
        cPtr_typeRecordVariable * operand_9905 = dynamic_cast <cPtr_typeRecordVariable *> (operand_9589->mInfo.mVariableDescriptor.getPtr ()) ;
        macroValidPointer (operand_9905) ; 
        ::routine_buildActualArgsList (_inLexique,  operand_9905->mMap,  var_cas_ioActualArgsList,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (310)) ;
      }else{ // Else part
          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a variable was expected here ; I found ")) + (operand_9589->mInfo.mVariableDescriptor.reader_variableDescriptorErrorMessage (_inLexique SOURCE_FILE_AT_LINE (313)))) SOURCE_FILE_AT_LINE (313)) ;
      }
    }
    operand_9589 = operand_9589->nextObject () ;
  }
}
