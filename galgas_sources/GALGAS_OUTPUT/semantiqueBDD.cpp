...
void routine_buildFormalArgsList (C_Lexique & _inLexique,
  ...
  if (var_cas_inVariableDescriptor._isBuilt ()) {
    if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_inVariableDescriptor.getPtr ()) != NULL) {
      ...
      var_cas_ioFormalArgsList._addAssign_operation (operand_8724->mIndex, operand_8724->mBitSize, operand_8724->mLowBound, operand_8724->mHighBound) ;
...
void routine_buildActualArgsList (C_Lexique & _inLexique,
  ...
  while ((operand_9582 != NULL)) {
    ...
    if (operand_9582->mInfo.mVariableDescriptor._isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectVariable *> (operand_9582->mInfo.mVariableDescriptor.getPtr ()) != NULL) {
        ...
        var_cas_ioActualArgsList._addAssign_operation (operand_9691->mIndex, operand_9691->mBitSize, operand_9691->mLowBound, operand_9691->mHighBound, var_cas_inErrorLocation) ;
