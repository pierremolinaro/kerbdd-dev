...
void routine_buildActualArgsList (C_Lexique & _inLexique,
  ...
  while ((operand_9544 != NULL)) {
    ...
    if (operand_9544->mInfo.mVariableDescriptor._isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectVariable *> (operand_9544->mInfo.mVariableDescriptor.getPtr ()) != NULL) {
      ...
      }else if (dynamic_cast <cPtr_typeRecordVariable *> (operand_9544->mInfo.mVariableDescriptor.getPtr ()) != NULL) {
