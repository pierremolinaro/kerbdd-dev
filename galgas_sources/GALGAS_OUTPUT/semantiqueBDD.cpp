...
//                    february 26th, 2008, at 11h37'56"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_verifierNombreArgumentsBool (C_Compiler & _inLexique,
  ...
  enumerator_7836.reset () ;
  enumerator_7907.reset () ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildFormalArgsList (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_typeVariableDescriptor _var_9284 = var_cas_inVariableDescriptor ; // CAST instruction
    if (_var_9284.getPtr () != NULL) {
      macroValidPointer (_var_9284.getPtr ()) ;
      if (dynamic_cast <cPtr_typeDirectVariable *> (_var_9284.getPtr ()) != NULL) {
        const GGS_typeDirectVariable var_cas_v (_var_9284.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_9284.getPtr ()) != NULL) {
        const GGS_typeRecordVariable var_cas_r (_var_9284.getPtr ()) ;
        GGS_typeTableVariablesBool::cEnumerator enumerator_9078 (var_cas_r.reader_mMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (293)), true) ;
        const GGS_typeTableVariablesBool::cElement * operand_9078 = NULL ;
        while (((operand_9078 = (GGS_typeTableVariablesBool::cElement *) enumerator_9078.nextObject ()))) {
          macroValidPointer (operand_9078) ;
          ::routine_buildFormalArgsList (_inLexique,  operand_9078->mInfo.mVariableDescriptor,  var_cas_ioFormalArgsList,  var_cas_inErrorLocation COMMA_SOURCE_FILE_AT_LINE (293)) ;
        }
        enumerator_9078.reset () ;
      }else{
      ...
      var_cas_inErrorLocation._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 2, & typeid (* (_var_9284.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (296)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildActualArgsList (C_Compiler & _inLexique,
  ...
  #endif
  GGS_typeTableVariablesBool::cEnumerator enumerator_9538 (var_cas_inDomainMap, true) ;
  const GGS_typeTableVariablesBool::cElement * operand_9538 = NULL ;
  while (((operand_9538 = (GGS_typeTableVariablesBool::cElement *) enumerator_9538.nextObject ()))) {
    macroValidPointer (operand_9538) ;
    { const GGS_typeVariableDescriptor _var_10288 = operand_9538->mInfo.mVariableDescriptor ; // CAST instruction
      if (_var_10288.getPtr () != NULL) {
        macroValidPointer (_var_10288.getPtr ()) ;
        if (dynamic_cast <cPtr_typeDirectVariable *> (_var_10288.getPtr ()) != NULL) {
          const GGS_typeDirectVariable var_cas_v (_var_10288.getPtr ()) ;
        ...
        }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_10288.getPtr ()) != NULL) {
          const GGS_typeRecordVariable var_cas_r (_var_10288.getPtr ()) ;
        ...
        var_cas_inErrorLocation._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 2, & typeid (* (_var_10288.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (317)) ;
        }
      }
    }
  }
  enumerator_9538.reset () ;
  #ifdef DEBUG_TRACE_ENABLED
