...
AC_galgasClassRunTimeInformation * GGS_typeDomain::_galgasObjectRunTimeInfo (void) const {
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mLowBound._operator_isEqual (ptr->mLowBound).boolValue ()
         && mHighBound._operator_isEqual (ptr->mHighBound).boolValue ()
         && mBitsCount._operator_isEqual (ptr->mBitsCount).boolValue () ;
  }
  return equal ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mDomain._operator_isEqual (ptr->mInfo.mDomain)).boolValue () ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mRecordMap._operator_isEqual (ptr->mRecordMap).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mVariableIndex._operator_isEqual (ptr->mVariableIndex).boolValue ()
         && mVariableBitSize._operator_isEqual (ptr->mVariableBitSize).boolValue ()
         && mLowBound._operator_isEqual (ptr->mLowBound).boolValue ()
         && mHighBound._operator_isEqual (ptr->mHighBound).boolValue () ;
  }
  return equal ;
}
...
void GGS_typeFormalArgumentsList::
_dotAssign_operation (const GGS_typeFormalArgumentsList inOperand) {
...
internalSubListWithRange (GGS_typeFormalArgumentsList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList._addAssign_operation (ptr->mVariableIndex, ptr->mVariableBitSize, ptr->mLowBound, ptr->mHighBound) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
/* const */ GGS_luint  & GGS_typeFormalArgumentsList::cEnumerator::_mVariableIndex (LOCATION_ARGS) const {
  ...
  return ((cElement *) mCurrentEnumeratedObject)->mVariableIndex ;
}
...
/* const */ GGS_luint  & GGS_typeFormalArgumentsList::cEnumerator::_mVariableBitSize (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mVariableBitSize ;
}
...
/* const */ GGS_luint  & GGS_typeFormalArgumentsList::cEnumerator::_mLowBound (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mLowBound ;
}
...
/* const */ GGS_luint  & GGS_typeFormalArgumentsList::cEnumerator::_mHighBound (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mHighBound ;
}
...
void GGS_typeActualArgumentsList::
_dotAssign_operation (const GGS_typeActualArgumentsList inOperand) {
  if (isBuilt () && inOperand.isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
internalSubListWithRange (GGS_typeActualArgumentsList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList._addAssign_operation (ptr->mVariableIndex, ptr->mVariableBitSize, ptr->mLowBound, ptr->mHighBound, ptr->mErrorLocation) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
AC_galgasClassRunTimeInformation * GGS_typeVariableDescriptor::_galgasObjectRunTimeInfo (void) const {
  AC_galgasClassRunTimeInformation * result = NULL ;
  if (mPointer != NULL) {
    result = mPointer->galgasRTTI () ;
  }
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mIndex._operator_isEqual (ptr->mIndex).boolValue ()
         && mBitSize._operator_isEqual (ptr->mBitSize).boolValue ()
         && mLowBound._operator_isEqual (ptr->mLowBound).boolValue ()
         && mHighBound._operator_isEqual (ptr->mHighBound).boolValue () ;
  }
  return equal ;
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mVariableDescriptor._operator_isEqual (ptr->mInfo.mVariableDescriptor)).boolValue () ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mMap._operator_isEqual (ptr->mMap).boolValue () ;
  }
  return equal ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.aListeArgsFormelsBool._operator_isEqual (ptr->mInfo.aListeArgsFormelsBool)).boolValue ()
           && (mInfo.aBDD._operator_isEqual (ptr->mInfo.aBDD)).boolValue () ;
}
...
AC_galgasClassRunTimeInformation * GGS_typeFormule::_galgasObjectRunTimeInfo (void) const {
  AC_galgasClassRunTimeInformation * result = NULL ;
  if (mPointer != NULL) {
    result = mPointer->galgasRTTI () ;
  }
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mNumeroVariable._operator_isEqual (ptr->mNumeroVariable).boolValue ()
         && mLowBound._operator_isEqual (ptr->mLowBound).boolValue ()
         && mHighBound._operator_isEqual (ptr->mHighBound).boolValue () ;
  }
  return equal ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mNumeroFormule._operator_isEqual (ptr->mNumeroFormule).boolValue ()
         && mListeArgsBool._operator_isEqual (ptr->mListeArgsBool).boolValue ()
         && mFormuleTraduite._operator_isEqual (ptr->mFormuleTraduite).boolValue ()
         && mEstFormuleCourante._operator_isEqual (ptr->mEstFormuleCourante).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mOperand._operator_isEqual (ptr->mOperand).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mOperand1._operator_isEqual (ptr->mOperand1).boolValue ()
         && mOperand2._operator_isEqual (ptr->mOperand2).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mOperand1._operator_isEqual (ptr->mOperand1).boolValue ()
         && mOperand2._operator_isEqual (ptr->mOperand2).boolValue ()
         && mOperand3._operator_isEqual (ptr->mOperand3).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mComparaison._operator_isEqual (ptr->mComparaison).boolValue ()
         && mOperand1._operator_isEqual (ptr->mOperand1).boolValue ()
         && mOperand2._operator_isEqual (ptr->mOperand2).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mListeArgsBooleens._operator_isEqual (ptr->mListeArgsBooleens).boolValue ()
         && mOperand._operator_isEqual (ptr->mOperand).boolValue ()
         && mContraints._operator_isEqual (ptr->mContraints).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mIndiceBDD._operator_isEqual (ptr->mIndiceBDD).boolValue ()
         && mDimension._operator_isEqual (ptr->mDimension).boolValue ()
         && mLowBound._operator_isEqual (ptr->mLowBound).boolValue ()
         && mHighBound._operator_isEqual (ptr->mHighBound).boolValue ()
         && mComparaison._operator_isEqual (ptr->mComparaison).boolValue ()
         && mValeur._operator_isEqual (ptr->mValeur).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mIndiceBDDgauche._operator_isEqual (ptr->mIndiceBDDgauche).boolValue ()
         && mDimension._operator_isEqual (ptr->mDimension).boolValue ()
         && mLeftLowBound._operator_isEqual (ptr->mLeftLowBound).boolValue ()
         && mLeftHighBound._operator_isEqual (ptr->mLeftHighBound).boolValue ()
         && mComparaison._operator_isEqual (ptr->mComparaison).boolValue ()
         && mIndiceBDDdroite._operator_isEqual (ptr->mIndiceBDDdroite).boolValue ()
         && mRightLowBound._operator_isEqual (ptr->mRightLowBound).boolValue ()
         && mRightHighBound._operator_isEqual (ptr->mRightHighBound).boolValue () ;
  }
  return equal ;
}
...
AC_galgasClassRunTimeInformation * GGS_typeCalcul::_galgasObjectRunTimeInfo (void) const {
  AC_galgasClassRunTimeInformation * result = NULL ;
  if (mPointer != NULL) {
    result = mPointer->galgasRTTI () ;
  }
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mNumeroFormule._operator_isEqual (ptr->mNumeroFormule).boolValue ()
         && mFormule._operator_isEqual (ptr->mFormule).boolValue ()
         && mNomFormule._operator_isEqual (ptr->mNomFormule).boolValue ()
         && mTableVariablesBool._operator_isEqual (ptr->mTableVariablesBool).boolValue ()
         && mAfficher._operator_isEqual (ptr->mAfficher).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mDimensionCache._operator_isEqual (ptr->mDimensionCache).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mDimensionTable._operator_isEqual (ptr->mDimensionTable).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mNumeroFormule._operator_isEqual (ptr->mNumeroFormule).boolValue ()
         ...
         && mNomFormule._operator_isEqual (ptr->mNomFormule).boolValue ()
         && mTableVariablesBool._operator_isEqual (ptr->mTableVariablesBool).boolValue ()
         && mSigne._operator_isEqual (ptr->mSigne).boolValue ()
         && mAfficher._operator_isEqual (ptr->mAfficher).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mCalcul._operator_isEqual (ptr->mCalcul).boolValue () ;
  }
  return equal ;
}
...
void GGS_typeListeCalculs::
_dotAssign_operation (const GGS_typeListeCalculs inOperand) {
  if (isBuilt () && inOperand.isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
...
internalSubListWithRange (GGS_typeListeCalculs & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList._addAssign_operation (ptr->mCalcul) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
/* const */ GGS_typeCalcul  & GGS_typeListeCalculs::cEnumerator::_mCalcul (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mCalcul ;
}
...
void routine_verifierNombreArgumentsBool (C_Compiler & inLexique,
  ...
  #endif
  if (((var_cas_t1.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (260)))._operator_strictInf (var_cas_t2.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (260)))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_t1.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (262)))._operator_strictSup (var_cas_t2.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (262)))).isBuiltAndTrue ()) {
  ...
  }
  {
    ...
    GGS_typeActualArgumentsList::cEnumerator enumerator_8048 (var_cas_t2, true) ;
    const GGS_typeActualArgumentsList::cElement * operand_8048 = NULL ;
    while (((operand_7967 = enumerator_7967.nextObject ()))
        && ((operand_8048 = enumerator_8048.nextObject ()))) {
      macroValidPointer (operand_7967) ;
      macroValidPointer (operand_8048) ;
      if (((operand_7967->mVariableBitSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (267)))._operator_isEqual (operand_8048->mVariableBitSize.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (267)))).isBuiltAndTrue ()) {
        if (((operand_7967->mLowBound.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (268)))._operator_isEqual (operand_8048->mLowBound.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (268)))).isBuiltAndTrue ()) {
          if (((operand_7967->mHighBound.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (269)))._operator_isEqual (operand_8048->mHighBound.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (269)))).isBuiltAndTrue ()) {
          }else{
            operand_8048->mErrorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the actual high bound is different the formal one") COMMA_SOURCE_FILE_AT_LINE (272)) ;
          }
        }else{
          operand_8048->mErrorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the actual low bound is different the formal one") COMMA_SOURCE_FILE_AT_LINE (275)) ;
        }
      }else{
        operand_8048->mErrorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the actual dimension is different from the formal one") COMMA_SOURCE_FILE_AT_LINE (278)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildFormalArgsList (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_typeVariableDescriptor _var_9420 = var_cas_inVariableDescriptor ; // CAST instruction
    if (_var_9420.getPtr () != NULL) {
      macroValidPointer (_var_9420.getPtr ()) ;
      if (dynamic_cast <cPtr_typeDirectVariable *> (_var_9420.getPtr ()) != NULL) {
        const GGS_typeDirectVariable var_cas_v (_var_9420.getPtr ()) ;
        var_cas_ioFormalArgsList._addAssign_operation (var_cas_v.reader_mIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (291)), var_cas_v.reader_mBitSize (inLexique COMMA_SOURCE_FILE_AT_LINE (291)), var_cas_v.reader_mLowBound (inLexique COMMA_SOURCE_FILE_AT_LINE (291)), var_cas_v.reader_mHighBound (inLexique COMMA_SOURCE_FILE_AT_LINE (291))) ;
      }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_9420.getPtr ()) != NULL) {
        const GGS_typeRecordVariable var_cas_r (_var_9420.getPtr ()) ;
        {
          GGS_typeTableVariablesBool::cEnumerator enumerator_9209 (var_cas_r.reader_mMap (inLexique COMMA_SOURCE_FILE_AT_LINE (293)), true) ;
          const GGS_typeTableVariablesBool::cElement * operand_9209 = NULL ;
          while (((operand_9209 = enumerator_9209.nextObject ()))) {
            macroValidPointer (operand_9209) ;
            ::routine_buildFormalArgsList (inLexique,  operand_9209->mInfo.mVariableDescriptor,  var_cas_ioFormalArgsList,  var_cas_inErrorLocation COMMA_SOURCE_FILE_AT_LINE (294)) ;
          }
        }
      }else{
      ...
      var_cas_inErrorLocation._castDefaultErrorMessage (inLexique, _castBranchDescriptor, 2, & typeid (* (_var_9420.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (297)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildActualArgsList (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_typeTableVariablesBool::cEnumerator enumerator_9680 (var_cas_inDomainMap, true) ;
    const GGS_typeTableVariablesBool::cElement * operand_9680 = NULL ;
    while (((operand_9680 = enumerator_9680.nextObject ()))) {
      macroValidPointer (operand_9680) ;
      { const GGS_typeVariableDescriptor _var_10066 = operand_9680->mInfo.mVariableDescriptor ; // CAST instruction
        if (_var_10066.getPtr () != NULL) {
          macroValidPointer (_var_10066.getPtr ()) ;
          if (dynamic_cast <cPtr_typeDirectVariable *> (_var_10066.getPtr ()) != NULL) {
            const GGS_typeDirectVariable var_cas_v (_var_10066.getPtr ()) ;
            var_cas_ioActualArgsList._addAssign_operation (var_cas_v.reader_mIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (310)), var_cas_v.reader_mBitSize (inLexique COMMA_SOURCE_FILE_AT_LINE (310)), var_cas_v.reader_mLowBound (inLexique COMMA_SOURCE_FILE_AT_LINE (310)), var_cas_v.reader_mHighBound (inLexique COMMA_SOURCE_FILE_AT_LINE (310)), var_cas_inErrorLocation) ;
          }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_10066.getPtr ()) != NULL) {
            const GGS_typeRecordVariable var_cas_r (_var_10066.getPtr ()) ;
          ...
          var_cas_inErrorLocation._castDefaultErrorMessage (inLexique, _castBranchDescriptor, 2, & typeid (* (_var_10066.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (314)) ;
          }
        }
      }
    }
