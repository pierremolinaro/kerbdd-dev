...
static const unsigned kBoolOptionCount = 9 ;
...
sint32 getStylesCount (void) {
  return lexiqueBDD::getStylesCount () ;
}

//---------------------------------------------------------------------------*

const char * getStyleName (const sint32 inIndex) {
  return lexiqueBDD::getStyleName (inIndex) ;
}

//---------------------------------------------------------------------------*

const char * getStyleIdentifier (const sint32 inIndex) {
  return lexiqueBDD::getStyleIdentifier (inIndex) ;
}
...
scanThenGetStyledRangeArray (NSString * inSourceString,
  ...
  if (gScannerPtr == NULL) {
    ...
    macroMyNew (gScannerPtr, lexiqueBDD (NULL, C_String (""), gIOParametersPtr, "" COMMA_HERE)) ;
  }
