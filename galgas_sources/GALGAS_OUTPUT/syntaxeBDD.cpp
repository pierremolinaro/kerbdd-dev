    ...
    while (syntaxRepeat) {
      switch (select_repeat_syntaxeBDD_0 (_inLexique)) {
        ...
        case 11 : {
          ...
          var_cas_afficherBDD = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 1UL), GGS_location (_inLexique) COMMA_HERE) ;
        ...
        case 12 : {
          ...
          GGS_luint  var_cas_afficherBDD ;
          var_cas_afficherBDD = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 2UL), GGS_location (_inLexique) COMMA_HERE) ;
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__23) ;
          nt_analyserFormule_ (_inLexique, var_cas_tableFormules, var_cas_ioDomainMap, var_cas_listeCalculs, var_cas_afficherBDD) ;
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__3B) ;
          } break ;
        case 13 : {
          ...
          GGS_luint  var_cas_afficherBDD ;
          var_cas_afficherBDD = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 3UL), GGS_location (_inLexique) COMMA_HERE) ;
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__23) ;
          nt_analyserFormule_ (_inLexique, var_cas_tableFormules, var_cas_ioDomainMap, var_cas_listeCalculs, var_cas_afficherBDD) ;
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__3B) ;
          } break ;
        case 14 : {
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__23) ;
          GGS_luint  var_cas_afficherBDD ;
          var_cas_afficherBDD = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 0UL), GGS_location (_inLexique) COMMA_HERE) ;
          nt_analyserFormule_ (_inLexique, var_cas_tableFormules, var_cas_ioDomainMap, var_cas_listeCalculs, var_cas_afficherBDD) ;
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__3B) ;
          } break ;
        default :
    ...
    case 1 : {
      ...
      switch (select_syntaxeBDD_2 (_inLexique)) {
        ...
        case 2 : {
          ...
          var_cas_lowBound = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 0UL), GGS_location (_inLexique) COMMA_HERE) ;
          switch (select_syntaxeBDD_3 (_inLexique)) {
            case 1 : {
              var_cas_highBound = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 1UL), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 2 : {
...
void routine_exploreRecordDomain (C_Lexique & _inLexique,
  ...
  while ((operand_8363 != NULL)) {
    ...
    if (operand_8363->mInfo.mDomain.isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectDomain *> (operand_8363->mInfo.mDomain.getPtr ()) != NULL) {
        cPtr_typeDirectDomain * operand_8439 = dynamic_cast <cPtr_typeDirectDomain *> (operand_8363->mInfo.mDomain.getPtr ()) ;
        ...
        var_cas_v = GGS_typeDirectVariable::constructor_new (_inLexique, var_cas_slot, operand_8439->mBitsCount, operand_8439->mLowBound, operand_8439->mHighBound COMMA_HERE) ;
        var_cas_outMap.method_insertKey (_inLexique, operand_8363->mKey, var_cas_v SOURCE_FILE_AT_LINE (348)) ;
        var_cas_ioBDDslot = var_cas_ioBDDslot.add_operation (_inLexique, operand_8439->mBitsCount.reader_value (_inLexique SOURCE_FILE_AT_LINE (349)) SOURCE_FILE_AT_LINE (349)) ;
         ;
      }else if (dynamic_cast <cPtr_typeRecordDomain *> (operand_8363->mInfo.mDomain.getPtr ()) != NULL) {
        cPtr_typeRecordDomain * operand_8779 = dynamic_cast <cPtr_typeRecordDomain *> (operand_8363->mInfo.mDomain.getPtr ()) ;
        macroValidPointer (operand_8779) ; 
        GGS_typeTableVariablesBool  var_cas_localMap ;
        ::routine_exploreRecordDomain (_inLexique,  operand_8779->mRecordMap,  var_cas_localMap,  var_cas_ioBDDslot,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (352)) ;
        GGS_typeVariableDescriptor  var_cas_v ;
        ...
        var_cas_outMap.method_insertKey (_inLexique, operand_8363->mKey, var_cas_v SOURCE_FILE_AT_LINE (354)) ;
          ...
          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a domain was expected here ; I found ")) + (operand_8363->mInfo.mDomain.reader_messageDomainType (_inLexique SOURCE_FILE_AT_LINE (356)))) SOURCE_FILE_AT_LINE (356)) ;
      }
    }
    ...
    while (syntaxRepeat) {
        ...
        if (var_cas_domain.isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) != NULL) {
            cPtr_typeDirectDomain * operand_9674 = dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) ;
            macroValidPointer (operand_9674) ; 
            GGS_luint  var_cas_slot ;
            var_cas_slot = GGS_luint::constructor_new (_inLexique, var_cas_ioBDDslot, GGS_location (_inLexique) COMMA_HERE) ;
            GGS_typeVariableDescriptor  var_cas_v ;
            var_cas_v = GGS_typeDirectVariable::constructor_new (_inLexique, var_cas_slot, operand_9674->mBitsCount, operand_9674->mLowBound, operand_9674->mHighBound COMMA_HERE) ;
            var_cas_tableVariables.method_insertKey (_inLexique, var_cas_nom, var_cas_v SOURCE_FILE_AT_LINE (379)) ;
            var_cas_ioBDDslot = var_cas_ioBDDslot.add_operation (_inLexique, operand_9674->mBitsCount.reader_value (_inLexique SOURCE_FILE_AT_LINE (380)) SOURCE_FILE_AT_LINE (380)) ;
             ;
            ...
            var_cas_listeArgFormelsBool.addAssign_operation (var_cas_num, operand_9674->mBitsCount, operand_9674->mLowBound, operand_9674->mHighBound) ;
          }else if (dynamic_cast <cPtr_typeRecordDomain *> (var_cas_domain.getPtr ()) != NULL) {
            cPtr_typeRecordDomain * operand_10184 = dynamic_cast <cPtr_typeRecordDomain *> (var_cas_domain.getPtr ()) ;
            macroValidPointer (operand_10184) ; 
            ...
            ::routine_exploreRecordDomain (_inLexique,  operand_10184->mRecordMap,  var_cas_recordMap,  var_cas_ioBDDslot,  var_cas_errorLocation SOURCE_FILE_AT_LINE (387)) ;
            GGS_typeVariableDescriptor  var_cas_v ;
  ...
  switch (select_syntaxeBDD_7 (_inLexique)) {
    case 1 : {
      ...
      switch (select_syntaxeBDD_8 (_inLexique)) {
        case 1 : {
          var_cas_highBound = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 1UL), GGS_location (_inLexique) COMMA_HERE) ;
          var_cas_dim = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 1UL), GGS_location (_inLexique) COMMA_HERE) ;
          } break ;
        case 2 : {
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__5B) ;
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1_nombre) ;
...
pr_facteur_formule_syntaxeBDD_894_23_ (lexiqueBDD & _inLexique,
  ...
  GGS_bdd var_cas_23860 ;
  if (var_cas_tableFormules.isBuilt ()) {
    var_cas_tableFormules (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_nom, var_cas_numero, var_cas_listeArgsFormelsBool, var_cas_23860 SOURCE_FILE_AT_LINE (906)) ;
  }
  _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__5B) ;
    ...
    while (syntaxRepeat) {
        ...
        if (var_cas_varDescriptor.isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
            cPtr_typeDirectVariable * operand_24125 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) ;
            macroValidPointer (operand_24125) ; 
            var_cas_listeArgsEffectifsBool.addAssign_operation (operand_24125->mIndex, operand_24125->mBitSize, operand_24125->mLowBound, operand_24125->mHighBound, var_cas_errorLocation) ;
          }else if (dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
            cPtr_typeRecordVariable * operand_24320 = dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) ;
            macroValidPointer (operand_24320) ; 
            ::routine_buildActualArgsList (_inLexique,  operand_24320->mMap,  var_cas_listeArgsEffectifsBool,  var_cas_errorLocation SOURCE_FILE_AT_LINE (917)) ;
          }else{ // Else part
