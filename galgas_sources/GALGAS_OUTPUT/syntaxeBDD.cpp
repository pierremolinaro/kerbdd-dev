  ...
  while ((operand_8363 != NULL)) {
    ...
    if (operand_8363->mInfo.mDomain._isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectDomain *> (operand_8363->mInfo.mDomain.getPtr ()) != NULL) {
        ...
        var_cas_ioBDDslot = var_cas_ioBDDslot._add_operation (_inLexique, operand_8439->mBitsCount.reader_value (_inLexique SOURCE_FILE_AT_LINE (349)) SOURCE_FILE_AT_LINE (349)) ;
    ...
    while (syntaxRepeat) {
        ...
        if (var_cas_domain._isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) != NULL) {
            ...
            var_cas_ioBDDslot = var_cas_ioBDDslot._add_operation (_inLexique, operand_9674->mBitsCount.reader_value (_inLexique SOURCE_FILE_AT_LINE (380)) SOURCE_FILE_AT_LINE (380)) ;
            ...
            var_cas_listeArgFormelsBool._addAssign_operation (var_cas_num, operand_9674->mBitsCount, operand_9674->mLowBound, operand_9674->mHighBound) ;
    ...
    while (syntaxRepeat) {
        ...
        if (var_cas_varDescriptor._isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
            ...
            var_cas_listeArgsEffectifsBool._addAssign_operation (operand_24181->mIndex, operand_24181->mBitSize, operand_24181->mLowBound, operand_24181->mHighBound, var_cas_errorLocation) ;
