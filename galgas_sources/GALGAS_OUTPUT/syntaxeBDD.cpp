...
void routine_exploreRecordDomain (C_Compiler & inLexique,
  ...
  var_cas_outMap = GGS_typeTableVariablesBool ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_8451 = enumerator_8451.nextObject ()))) {
      ...
      { const GGS_typeDomain _var_9270 = operand_8451->mInfo.mDomain ; // CAST instruction
        if (_var_9270.getPtr () != NULL) {
          macroValidPointer (_var_9270.getPtr ()) ;
          if (dynamic_cast <cPtr_typeDirectDomain *> (_var_9270.getPtr ()) != NULL) {
            const GGS_typeDirectDomain var_cas_dd (_var_9270.getPtr ()) ;
          ...
          }else if (dynamic_cast <cPtr_typeRecordDomain *> (_var_9270.getPtr ()) != NULL) {
            const GGS_typeRecordDomain var_cas_rd (_var_9270.getPtr ()) ;
...
pr_declarations_syntaxeBDD_363_19_ (lexiqueBDD & inLexique,
  ...
  { bool syntaxRepeat_6 = true ;
    while (syntaxRepeat_6) {
        ...
        { const GGS_typeDomain _var_11783 = var_cas_aDomain ; // CAST instruction
          if (_var_11783.getPtr () != NULL) {
            macroValidPointer (_var_11783.getPtr ()) ;
            if (dynamic_cast <cPtr_typeDirectDomain *> (_var_11783.getPtr ()) != NULL) {
              const GGS_typeDirectDomain var_cas_dd (_var_11783.getPtr ()) ;
              GGS_luint  var_cas_slot = GGS_luint ::constructor_new (inLexique, var_cas_ioBDDslot, GGS_location (inLexique) COMMA_HERE) ;
              ...
              { const GGS_typeVariableDescriptor _var_10312 = var_cas_v ; // CAST instruction
                if (_var_10312.getPtr () != NULL) {
                  macroValidPointer (_var_10312.getPtr ()) ;
                  if (dynamic_cast <cPtr_typeDirectVariable *> (_var_10312.getPtr ()) != NULL) {
                    const GGS_typeDirectVariable var_cas_dv (_var_10312.getPtr ()) ;
                  ...
                  var_cas_nom._castDefaultErrorMessage (inLexique, _castBranchDescriptor, 1, & typeid (* (_var_10312.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (385)) ;
                  }
                }
              }
            }else if (dynamic_cast <cPtr_typeRecordDomain *> (_var_11783.getPtr ()) != NULL) {
              const GGS_typeRecordDomain var_cas_rd (_var_11783.getPtr ()) ;
...
pr_dimension_syntaxeBDD_421_16_ (lexiqueBDD & inLexique,
  ...
  switch (select_syntaxeBDD_7 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.assignFromAttribute_att_token (var_cas_domainName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_id) COMMA_HERE) ;
      const GGS_typeDomainMap  temp_12588 = var_cas_ioDomainMap ;
      if (temp_12588.isBuilt ()) {
        temp_12588 (HERE)->method_searchKey (inLexique, var_cas_domainName, var_cas_outDomain COMMA_SOURCE_FILE_AT_LINE (444)) ;
      }
      } break ;
    default :
      break ;
...
pr_facteur_formule_syntaxeBDD_912_22_ (lexiqueBDD & inLexique,
  ...
  const GGS_typeTableFormules  temp_24975 = var_cas_tableFormules ;
  if (temp_24975.isBuilt ()) {
    temp_24975 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_nom, var_cas_numero, var_cas_listeArgsFormelsBool, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (924)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__5B_) COMMA_HERE) ;
  ...
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
        ...
        { const GGS_typeVariableDescriptor _var_25806 = var_cas_varDescriptor ; // CAST instruction
          if (_var_25806.getPtr () != NULL) {
            macroValidPointer (_var_25806.getPtr ()) ;
            if (dynamic_cast <cPtr_typeDirectVariable *> (_var_25806.getPtr ()) != NULL) {
              const GGS_typeDirectVariable var_cas_dv (_var_25806.getPtr ()) ;
            ...
            }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_25806.getPtr ()) != NULL) {
              const GGS_typeRecordVariable var_cas_rv (_var_25806.getPtr ()) ;
...
pr_parse_argument_syntaxeBDD_954_21_ (lexiqueBDD & inLexique,
  ...
  const GGS_typeTableVariablesBool  temp_26529 = var_cas_ioVarMap ;
  if (temp_26529.isBuilt ()) {
    temp_26529 (HERE)->method_searchKey (inLexique, var_cas_varName, var_cas_outVarDescriptor COMMA_SOURCE_FILE_AT_LINE (962)) ;
  }
    ...
    while (syntaxRepeat_13) {
      switch (select_repeat_syntaxeBDD_13 (inLexique)) {
        case 2 : {
          ...
          const GGS_typeTableVariablesBool  temp_27012 = var_cas_fieldMap ;
          if (temp_27012.isBuilt ()) {
            temp_27012 (HERE)->method_searchKey (inLexique, var_cas_fieldName, var_cas_outVarDescriptor COMMA_SOURCE_FILE_AT_LINE (974)) ;
          }
          } break ;
        default :
