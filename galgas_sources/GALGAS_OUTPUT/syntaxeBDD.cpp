    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_syntaxeBDD_0 (inLexique)) {
        case 2 : {
          ...
          inLexique._assignFromAttribute_att_token (var_cas_domainName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_id) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__3A) COMMA_HERE) ;
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__3B) COMMA_HERE) ;
          } break ;
        case 3 : {
          ...
          inLexique._assignFromAttribute_att_token (var_cas_nomFichierInclusion) ;
        ...
        case 4 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_use_5Fand) COMMA_HERE) ;
        ...
        case 5 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_use_5Fite) COMMA_HERE) ;
          GGS_typeCalcul  var_cas_calcul ;
        ...
        case 6 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_use_5Fand_5Fite) COMMA_HERE) ;
          GGS_typeCalcul  var_cas_calcul ;
        ...
        case 7 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_and_5Fcache) COMMA_HERE) ;
          GGS_luint  var_cas_dimensionCache ;
          inLexique._assignFromAttribute_att_valeur (var_cas_dimensionCache) ;
        ...
        case 8 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_ite_5Fcache) COMMA_HERE) ;
          GGS_luint  var_cas_dimensionCache ;
          inLexique._assignFromAttribute_att_valeur (var_cas_dimensionCache) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_nombre) COMMA_HERE) ;
          GGS_typeCalcul  var_cas_calcul ;
        ...
        case 9 : {
          ...
          inLexique._assignFromAttribute_att_valeur (var_cas_dimensionTable) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_nombre) COMMA_HERE) ;
          GGS_typeCalcul  var_cas_calcul ;
        ...
        case 11 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__23) COMMA_HERE) ;
  ...
  switch (select_syntaxeBDD_1 (inLexique)) {
    case 1 : {
      ...
      switch (select_syntaxeBDD_2 (inLexique)) {
        case 1 : {
          inLexique._assignFromAttribute_att_valeur (var_cas_lowBound) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_nombre) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__2E_2E) COMMA_HERE) ;
          inLexique._assignFromAttribute_att_valeur (var_cas_highBound) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_nombre) COMMA_HERE) ;
          } break ;
        case 2 : {
          ...
          switch (select_syntaxeBDD_3 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__5B) COMMA_HERE) ;
              GGS_luint  var_cas_dim ;
              inLexique._assignFromAttribute_att_valeur (var_cas_dim) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_nombre) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__5D) COMMA_HERE) ;
    ...
    case 2 : {
      ...
      { bool syntaxRepeat_4 = true ;
        while (syntaxRepeat_4) {
            ...
            inLexique._assignFromAttribute_att_token (var_cas_fieldName) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_id) COMMA_HERE) ;
            inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__3A) COMMA_HERE) ;
            GGS_typeDomain  var_cas_d ;
            nt_domainDefinition_ (inLexique, var_cas_ioDomainMap, var_cas_d) ;
...
pr_analyserFormule_syntaxeBDD_276_22_ (lexiqueBDD & inLexique,
  ...
  inLexique._assignFromAttribute_att_token (var_cas_nomFormule) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_id) COMMA_HERE) ;
      ...
      { const GGS_typeDomain _var_9309 = operand_8446->mInfo.mDomain ; // CAST instruction
        if (_var_9309.getPtr () != NULL) {
          ...
          if (dynamic_cast <cPtr_typeDirectDomain *> (_var_9309.getPtr ()) != NULL) {
            ...
            var_cas_ioBDDslot = var_cas_ioBDDslot._add_operation (inLexique, var_cas_dd.reader_mBitsCount (inLexique COMMA_SOURCE_FILE_AT_LINE (349)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (349)) COMMA_SOURCE_FILE_AT_LINE (349)) ;
            ...
            var_cas_inErrorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("a aDomain was expected here ; I found "))._operator_concat (operand_8446->mInfo.mDomain.reader_messageDomainType (inLexique COMMA_SOURCE_FILE_AT_LINE (356))) COMMA_SOURCE_FILE_AT_LINE (357)) ;
          }
        }
      }
    }
...
pr_declarations_syntaxeBDD_363_19_ (lexiqueBDD & inLexique,
  ...
  { bool syntaxRepeat_6 = true ;
    while (syntaxRepeat_6) {
        ...
        inLexique._assignFromAttribute_att_token (var_cas_nom) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_id) COMMA_HERE) ;
        ...
        { const GGS_typeDomain _var_11822 = var_cas_aDomain ; // CAST instruction
          if (_var_11822.getPtr () != NULL) {
            ...
            if (dynamic_cast <cPtr_typeDirectDomain *> (_var_11822.getPtr ()) != NULL) {
              ...
              var_cas_ioBDDslot = var_cas_ioBDDslot._add_operation (inLexique, var_cas_dd.reader_mBitsCount (inLexique COMMA_SOURCE_FILE_AT_LINE (380)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (380)) COMMA_SOURCE_FILE_AT_LINE (380)) ;
              ...
              var_cas_nom.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("a aDomain was expected here ; I found "))._operator_concat (var_cas_aDomain.reader_messageDomainType (inLexique COMMA_SOURCE_FILE_AT_LINE (410))) COMMA_SOURCE_FILE_AT_LINE (411)) ;
            }
          }
        }
      switch (select_repeat_syntaxeBDD_6 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__2C) COMMA_HERE) ;
          } break ;
        default :
...
pr_type_formule_syntaxeBDD_452_19_ (lexiqueBDD & inLexique,
                                ...
                                GGS_luint  var_cas_afficherBDD,
                                GGS_typeCalcul  &var_cas_calcul) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__3A_3D) COMMA_HERE) ;
...
pr_type_formule_syntaxeBDD_480_19_ (lexiqueBDD & inLexique,
                                ...
                                GGS_luint  var_cas_afficherBDD,
                                GGS_typeCalcul  &var_cas_calcul) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__2B_3D) COMMA_HERE) ;
...
pr_type_formule_syntaxeBDD_509_19_ (lexiqueBDD & inLexique,
                                ...
                                GGS_luint  var_cas_afficherBDD,
                                GGS_typeCalcul  &var_cas_calcul) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__2D_3D) COMMA_HERE) ;
  GGS_lbool  var_cas_signe ;
    ...
    while (syntaxRepeat_9) {
      switch (select_repeat_syntaxeBDD_9 (inLexique)) {
        case 2 : {
          ...
          inLexique._assignFromAttribute_att_valeur (var_cas_comparaison) ;
        ...
        case 3 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__2D_3E) COMMA_HERE) ;
          GGS_typeFormule  var_cas_g ;
          GGS_typeFormule  var_cas_h ;
          var_cas_h = var_cas_formule ;
          nt_egalite_formule_ (inLexique, var_cas_tableVariables, var_cas_inBDDslot, var_cas_ioDomainMap, var_cas_tableFormules, var_cas_g) ;
  ...
  { bool syntaxRepeat_10 = true ;
    while (syntaxRepeat_10) {
      switch (select_repeat_syntaxeBDD_10 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__7C) COMMA_HERE) ;
          GGS_typeFormule  var_cas_g ;
          GGS_typeFormule  var_cas_h ;
          var_cas_h = var_cas_formule ;
  ...
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
      switch (select_repeat_syntaxeBDD_11 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__26) COMMA_HERE) ;
          GGS_typeFormule  var_cas_g ;
          GGS_typeFormule  var_cas_h ;
          var_cas_h = var_cas_formule ;
...
pr_facteur_formule_syntaxeBDD_655_22_ (lexiqueBDD & inLexique,
                                ...
                                GGS_typeTableFormules  &var_cas_tableFormules,
                                GGS_typeFormule  &var_cas_formule) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__28) COMMA_HERE) ;
  nt_formule_ (inLexique, var_cas_tableVariables, var_cas_inBDDslot, var_cas_ioDomainMap, var_cas_tableFormules, var_cas_formule) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__29) COMMA_HERE) ;
}
...
pr_facteur_formule_syntaxeBDD_688_22_ (lexiqueBDD & inLexique,
                                ...
                                GGS_typeTableFormules  &/* var_cas_tableFormules */,
                                GGS_typeFormule  &var_cas_formule) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__7B) COMMA_HERE) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__7D) COMMA_HERE) ;
}
...
pr_comparaisonVariable_syntaxeBDD_714_26_ (lexiqueBDD & inLexique,
  ...
  inLexique._assignFromAttribute_att_valeur (var_cas_valeur) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_nombre) COMMA_HERE) ;
  if (var_cas_dim.isBuilt () &&
...
pr_facteur_formule_syntaxeBDD_767_22_ (lexiqueBDD & inLexique,
                                ...
                                GGS_typeTableFormules  &var_cas_tableFormules,
                                GGS_typeFormule  &var_cas_formule) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__7E) COMMA_HERE) ;
  GGS_typeFormule  var_cas_f ;
...
pr_facteur_formule_syntaxeBDD_828_22_ (lexiqueBDD & inLexique,
                                ...
                                GGS_typeTableFormules  &var_cas_tableFormules,
                                GGS_typeFormule  &var_cas_formule) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__21) COMMA_HERE) ;
...
pr_facteur_formule_syntaxeBDD_862_22_ (lexiqueBDD & inLexique,
                                ...
                                GGS_typeTableFormules  &var_cas_tableFormules,
                                GGS_typeFormule  &var_cas_formule) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__3F) COMMA_HERE) ;
  GGS_typeFormalArgumentsList  var_cas_listeNumVarsBool ;
  GGS_typeTableVariablesBool  var_cas_tableLocaleVariables ;
  var_cas_tableLocaleVariables = var_cas_tableVariables ;
  GGS_uint  var_cas_bddSlot ;
        ...
        { const GGS_typeVariableDescriptor _var_25845 = var_cas_varDescriptor ; // CAST instruction
          if (_var_25845.getPtr () != NULL) {
            ...
            if (dynamic_cast <cPtr_typeDirectVariable *> (_var_25845.getPtr ()) != NULL) {
              ...
              var_cas_errorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("a variable was expected here ; I found "))._operator_concat (var_cas_varDescriptor.reader_variableDescriptorErrorMessage (inLexique COMMA_SOURCE_FILE_AT_LINE (938))) COMMA_SOURCE_FILE_AT_LINE (939)) ;
            }
          }
        }
...
pr_parse_argument_syntaxeBDD_954_21_ (lexiqueBDD & inLexique,
  ...
  inLexique._assignFromAttribute_att_token (var_cas_varName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_id) COMMA_HERE) ;
  ...
  { bool syntaxRepeat_13 = true ;
    while (syntaxRepeat_13) {
      switch (select_repeat_syntaxeBDD_13 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__2E) COMMA_HERE) ;
          GGS_typeRecordVariable  var_cas_rv ;
          var_cas_rv = GGS_typeRecordVariable::_castFrom (inLexique, var_cas_outVarDescriptor.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (969)) ;
...
pr_parse_scalar_argument_syntaxeBDD_980_28_ (lexiqueBDD & inLexique,
  ...
  var_cas_variable = GGS_typeDirectVariable::_castFrom (inLexique, var_cas_v.getPtr (), false, var_cas_outErrorLocation COMMA_SOURCE_FILE_AT_LINE (992)) ;
