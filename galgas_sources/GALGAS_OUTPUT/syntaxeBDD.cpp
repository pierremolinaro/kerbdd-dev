...
pr_domainDefinition_syntaxeBDD_222_23_ (lexiqueBDD & inLexique,
  ...
  switch (select_syntaxeBDD_1 (inLexique)) {
    ...
    case 3 : {
      ...
      inLexique.assignFromAttribute_att_token (var_cas_domainName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_id) COMMA_HERE) ;
      const GGS_typeDomainMap  temp_6542 = var_cas_ioDomainMap ;
      if (temp_6542.isBuilt ()) {
        temp_6542 (HERE)->method_searchKey (inLexique, var_cas_domainName, var_cas_outDomain COMMA_SOURCE_FILE_AT_LINE (268)) ;
      }
      } break ;
    default :
      break ;
...
void routine_exploreRecordDomain (C_Compiler & inLexique,
  ...
  {
    GGS_typeDomainMap::cEnumerator enumerator_8451 (var_cas_inRecordMap, true) ;
    const GGS_typeDomainMap::cElement * operand_8451 = NULL ;
    while (((operand_8451 = enumerator_8451.nextObject ()))) {
      macroValidPointer (operand_8451) ;
      { const GGS_typeDomain _var_9314 = operand_8451->mInfo.mDomain ; // CAST instruction
        if (_var_9314.getPtr () != NULL) {
          ...
          if (dynamic_cast <cPtr_typeDirectDomain *> (_var_9314.getPtr ()) != NULL) {
            ...
            GGS_typeVariableDescriptor  var_cas_v = GGS_typeDirectVariable ::constructor_new (inLexique, var_cas_slot, var_cas_dd.reader_mBitsCount (inLexique COMMA_SOURCE_FILE_AT_LINE (347)), var_cas_dd.reader_mLowBound (inLexique COMMA_SOURCE_FILE_AT_LINE (347)), var_cas_dd.reader_mHighBound (inLexique COMMA_SOURCE_FILE_AT_LINE (347)) COMMA_HERE) ;
            var_cas_outMap.modifier_insertKey (inLexique, operand_8451->mKey, var_cas_v COMMA_SOURCE_FILE_AT_LINE (348)) ;
            ...
            var_cas_outMap.modifier_insertKey (inLexique, operand_8451->mKey, var_cas_v COMMA_SOURCE_FILE_AT_LINE (354)) ;
          }else{
            var_cas_inErrorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("a aDomain was expected here ; I found ")).operator_concat (operand_8451->mInfo.mDomain.reader_messageDomainType (inLexique COMMA_SOURCE_FILE_AT_LINE (356))) COMMA_SOURCE_FILE_AT_LINE (357)) ;
          }
        }
      }
    }
        ...
        { const GGS_typeDomain _var_11827 = var_cas_aDomain ; // CAST instruction
          if (_var_11827.getPtr () != NULL) {
            ...
            if (dynamic_cast <cPtr_typeDirectDomain *> (_var_11827.getPtr ()) != NULL) {
              ...
              GGS_luint  var_cas_slot = GGS_luint ::constructor_new (inLexique, var_cas_ioBDDslot, GGS_location (inLexique) COMMA_HERE) ;
              GGS_typeVariableDescriptor  var_cas_v = GGS_typeDirectVariable ::constructor_new (inLexique, var_cas_slot, var_cas_dd.reader_mBitsCount (inLexique COMMA_SOURCE_FILE_AT_LINE (378)), var_cas_dd.reader_mLowBound (inLexique COMMA_SOURCE_FILE_AT_LINE (378)), var_cas_dd.reader_mHighBound (inLexique COMMA_SOURCE_FILE_AT_LINE (378)) COMMA_HERE) ;
              ...
              { const GGS_typeVariableDescriptor _var_10356 = var_cas_v ; // CAST instruction
                if (_var_10356.getPtr () != NULL) {
                  ...
                  if (dynamic_cast <cPtr_typeDirectVariable *> (_var_10356.getPtr ()) != NULL) {
                    ...
                    var_cas_listeArgFormelsBool.addAssign_operation (var_cas_dv.reader_mIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (383)), var_cas_dd.reader_mBitsCount (inLexique COMMA_SOURCE_FILE_AT_LINE (383)), var_cas_dd.reader_mLowBound (inLexique COMMA_SOURCE_FILE_AT_LINE (383)), var_cas_dd.reader_mHighBound (inLexique COMMA_SOURCE_FILE_AT_LINE (383))) ;
                  }else{
                  const castBranchDescriptorType _castBranchDescriptor [1] = {
                    {& typeid (cPtr_typeDirectVariable), true}
                  } ;
                  var_cas_nom._castDefaultErrorMessage (inLexique, _castBranchDescriptor, 1, & typeid (* (_var_10356.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (385)) ;
                  }
                }
              }
  ...
  switch (select_syntaxeBDD_7 (inLexique)) {
    ...
    case 2 : {
      ...
      if (temp_12632.isBuilt ()) {
        temp_12632 (HERE)->method_searchKey (inLexique, var_cas_domainName, var_cas_outDomain COMMA_SOURCE_FILE_AT_LINE (444)) ;
      }
      } break ;
    default :
      break ;
...
pr_facteur_formule_syntaxeBDD_912_22_ (lexiqueBDD & inLexique,
  ...
  const GGS_typeTableFormules  temp_25019 = var_cas_tableFormules ;
  if (temp_25019.isBuilt ()) {
    temp_25019 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_nom, var_cas_numero, var_cas_listeArgsFormelsBool, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (924)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__5B_) COMMA_HERE) ;
  ...
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
        ...
        { const GGS_typeVariableDescriptor _var_25850 = var_cas_varDescriptor ; // CAST instruction
          if (_var_25850.getPtr () != NULL) {
            macroValidPointer (_var_25850.getPtr ()) ;
            if (dynamic_cast <cPtr_typeDirectVariable *> (_var_25850.getPtr ()) != NULL) {
              const GGS_typeDirectVariable var_cas_dv (_var_25850.getPtr ()) ;
              var_cas_listeArgsEffectifsBool.addAssign_operation (var_cas_dv.reader_mIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (933)), var_cas_dv.reader_mBitSize (inLexique COMMA_SOURCE_FILE_AT_LINE (933)), var_cas_dv.reader_mLowBound (inLexique COMMA_SOURCE_FILE_AT_LINE (933)), var_cas_dv.reader_mHighBound (inLexique COMMA_SOURCE_FILE_AT_LINE (933)), var_cas_errorLocation) ;
            }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_25850.getPtr ()) != NULL) {
              const GGS_typeRecordVariable var_cas_rv (_var_25850.getPtr ()) ;
...
pr_parse_argument_syntaxeBDD_954_21_ (lexiqueBDD & inLexique,
  ...
  const GGS_typeTableVariablesBool  temp_26573 = var_cas_ioVarMap ;
  if (temp_26573.isBuilt ()) {
    temp_26573 (HERE)->method_searchKey (inLexique, var_cas_varName, var_cas_outVarDescriptor COMMA_SOURCE_FILE_AT_LINE (962)) ;
  }
    ...
    while (syntaxRepeat_13) {
      switch (select_repeat_syntaxeBDD_13 (inLexique)) {
        case 2 : {
          ...
          GGS_typeRecordVariable  var_cas_rv = GGS_typeRecordVariable::castFrom (inLexique, var_cas_outVarDescriptor.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (969)) ;
          GGS_typeTableVariablesBool  var_cas_fieldMap = var_cas_rv.reader_mMap (inLexique COMMA_SOURCE_FILE_AT_LINE (970)) ;
          GGS_lstring  var_cas_fieldName ;
          inLexique.assignFromAttribute_att_token (var_cas_fieldName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_id) COMMA_HERE) ;
          var_cas_outErrorLocation = var_cas_fieldName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (973)) ;
          const GGS_typeTableVariablesBool  temp_27056 = var_cas_fieldMap ;
          if (temp_27056.isBuilt ()) {
            temp_27056 (HERE)->method_searchKey (inLexique, var_cas_fieldName, var_cas_outVarDescriptor COMMA_SOURCE_FILE_AT_LINE (974)) ;
          }
          } break ;
        default :
...
pr_parse_scalar_argument_syntaxeBDD_980_28_ (lexiqueBDD & inLexique,
  ...
  GGS_typeDirectVariable  var_cas_variable = GGS_typeDirectVariable::castFrom (inLexique, var_cas_v.getPtr (), false, var_cas_outErrorLocation COMMA_SOURCE_FILE_AT_LINE (992)) ;
