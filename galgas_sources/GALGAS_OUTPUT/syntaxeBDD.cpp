    ...
    while (syntaxRepeat) {
      switch (select_repeat_syntaxeBDD_0 (_inLexique)) {
        case 2 : {
          ...
          var_cas_ioDomainMap.methode_insertKey (_inLexique, var_cas_domainName, var_cas_d SOURCE_FILE_AT_LINE (132)) ;
...
pr_domainDefinition_syntaxeBDD_222_24_ (lexiqueBDD & _inLexique,
  ...
  switch (select_syntaxeBDD_1 (_inLexique)) {
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            nt_domainDefinition_ (_inLexique, var_cas_ioDomainMap, var_cas_d) ;
            _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__3B) ;
            var_cas_recordDomainMap.methode_insertKey (_inLexique, var_cas_fieldName, var_cas_d SOURCE_FILE_AT_LINE (259)) ;
    ...
    case 3 : {
      ...
      _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1_id) ;
      var_cas_domainName.defineAttribute (_inLexique.att_token, _inLexique) ;
      var_cas_ioDomainMap.methode_searchKey (_inLexique, var_cas_domainName, var_cas_outDomain SOURCE_FILE_AT_LINE (268)) ;
      } break ;
    default :
      break ;
  }
...
pr_argsFormelsFormule_syntaxeBDD_311_26_ (lexiqueBDD & _inLexique,
  ...
  var_cas_outBDDslot = GGS_uint (true, 0UL) ;
...
void routine_exploreRecordDomain (C_Lexique & _inLexique,
  ...
  GGS_typeDomainMap::element_type * operand_8352 = var_cas_inRecordMap.firstObject () ;
  while ((operand_8352 != NULL)) {
    macroValidPointer (operand_8352) ;
    if (operand_8352->mInfo.mDomain.isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectDomain *> (operand_8352->mInfo.mDomain.getPtr ()) != NULL) {
        cPtr_typeDirectDomain * operand_8428 = dynamic_cast <cPtr_typeDirectDomain *> (operand_8352->mInfo.mDomain.getPtr ()) ;
        macroValidPointer (operand_8428) ; 
        GGS_luint  var_cas_slot ;
        var_cas_slot = GGS_luint::constructor_new (var_cas_ioBDDslot, GGS_location (_inLexique) COMMA_HERE) ;
        GGS_typeVariableDescriptor  var_cas_v ;
        var_cas_v = GGS_typeDirectVariable::constructor_new (var_cas_slot, operand_8428->mBitsCount, operand_8428->mLowBound, operand_8428->mHighBound COMMA_HERE) ;
        var_cas_outMap.methode_insertKey (_inLexique, operand_8352->mKey, var_cas_v SOURCE_FILE_AT_LINE (348)) ;
        var_cas_ioBDDslot = var_cas_ioBDDslot.add_operation (_inLexique, operand_8428->mBitsCount.reader_value (_inLexique SOURCE_FILE_AT_LINE (349)) SOURCE_FILE_AT_LINE (349)) ;
         ;
      }else if (dynamic_cast <cPtr_typeRecordDomain *> (operand_8352->mInfo.mDomain.getPtr ()) != NULL) {
        cPtr_typeRecordDomain * operand_8768 = dynamic_cast <cPtr_typeRecordDomain *> (operand_8352->mInfo.mDomain.getPtr ()) ;
        ...
        var_cas_outMap.methode_insertKey (_inLexique, operand_8352->mKey, var_cas_v SOURCE_FILE_AT_LINE (354)) ;
      }else{ // Else part
          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a domain was expected here ; I found ")) + (operand_8352->mInfo.mDomain.reader_messageDomainType (_inLexique SOURCE_FILE_AT_LINE (356)))) SOURCE_FILE_AT_LINE (356)) ;
      }
    }
    operand_8352 = operand_8352->nextObject () ;
  }
}
    ...
    while (syntaxRepeat) {
        ...
        if (var_cas_domain.isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) != NULL) {
            cPtr_typeDirectDomain * operand_9659 = dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) ;
            macroValidPointer (operand_9659) ; 
            GGS_luint  var_cas_slot ;
            var_cas_slot = GGS_luint::constructor_new (var_cas_ioBDDslot, GGS_location (_inLexique) COMMA_HERE) ;
            GGS_typeVariableDescriptor  var_cas_v ;
            var_cas_v = GGS_typeDirectVariable::constructor_new (var_cas_slot, operand_9659->mBitsCount, operand_9659->mLowBound, operand_9659->mHighBound COMMA_HERE) ;
            var_cas_tableVariables.methode_insertKey (_inLexique, var_cas_nom, var_cas_v SOURCE_FILE_AT_LINE (379)) ;
            var_cas_ioBDDslot = var_cas_ioBDDslot.add_operation (_inLexique, operand_9659->mBitsCount.reader_value (_inLexique SOURCE_FILE_AT_LINE (380)) SOURCE_FILE_AT_LINE (380)) ;
             ;
            ...
            var_cas_listeArgFormelsBool.addAssign_operation (var_cas_num, operand_9659->mBitsCount, operand_9659->mLowBound, operand_9659->mHighBound) ;
          }else if (dynamic_cast <cPtr_typeRecordDomain *> (var_cas_domain.getPtr ()) != NULL) {
            cPtr_typeRecordDomain * operand_10169 = dynamic_cast <cPtr_typeRecordDomain *> (var_cas_domain.getPtr ()) ;
            macroValidPointer (operand_10169) ; 
            ...
            ::routine_exploreRecordDomain (_inLexique,  operand_10169->mRecordMap,  var_cas_recordMap,  var_cas_ioBDDslot,  var_cas_errorLocation SOURCE_FILE_AT_LINE (387)) ;
            GGS_typeVariableDescriptor  var_cas_v ;
            var_cas_v = GGS_typeRecordVariable::constructor_new (var_cas_recordMap COMMA_HERE) ;
            var_cas_tableVariables.methode_insertKey (_inLexique, var_cas_nom, var_cas_v SOURCE_FILE_AT_LINE (389)) ;
            ::routine_buildFormalArgsList (_inLexique,  var_cas_v,  var_cas_listeArgFormelsBool,  var_cas_errorLocation SOURCE_FILE_AT_LINE (390)) ;
              ...
              var_cas_nom.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a domain was expected here ; I found ")) + (var_cas_domain.reader_messageDomainType (_inLexique SOURCE_FILE_AT_LINE (392)))) SOURCE_FILE_AT_LINE (392)) ;
          }
        }
...
pr_dimension_syntaxeBDD_403_17_ (lexiqueBDD & _inLexique,
  ...
  switch (select_syntaxeBDD_7 (_inLexique)) {
    ...
    case 2 : {
      ...
      _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1_id) ;
      var_cas_domainName.defineAttribute (_inLexique.att_token, _inLexique) ;
      var_cas_ioDomainMap.methode_searchKey (_inLexique, var_cas_domainName, var_cas_outDomain SOURCE_FILE_AT_LINE (426)) ;
      } break ;
    default :
      break ;
  }
...
pr_type_formule_syntaxeBDD_434_20_ (lexiqueBDD & _inLexique,
  ...
  var_cas_tableFormules.methode_insertKeyGetIndex (_inLexique, var_cas_nomFormule, var_cas_numero, var_cas_listeArgFormelsBool, var_cas_unusedBDD SOURCE_FILE_AT_LINE (456)) ;
...
pr_type_formule_syntaxeBDD_462_20_ (lexiqueBDD & _inLexique,
  ...
  GGS_bdd var_cas_unusedBDD ;
  var_cas_unusedBDD = GGS_bdd::constructor_empty (HERE) ;
  var_cas_tableFormules.methode_insertKeyGetIndex (_inLexique, var_cas_nomFormule, var_cas_numero, var_cas_listeArgFormelsBool, var_cas_unusedBDD SOURCE_FILE_AT_LINE (476)) ;
  GGS_typeFormule  var_cas_f ;
  GGS_typeTableVariablesBool  var_cas_tableVariablesLocales ;
  var_cas_tableVariablesLocales = var_cas_tableVariables ;
  nt_formule_ (_inLexique, var_cas_tableVariablesLocales, var_cas_inBDDslot, var_cas_ioDomainMap, var_cas_tableFormules, var_cas_f) ;
...
pr_type_formule_syntaxeBDD_491_20_ (lexiqueBDD & _inLexique,
  ...
  GGS_bdd var_cas_unusedBDD ;
  var_cas_unusedBDD = GGS_bdd::constructor_empty (HERE) ;
  var_cas_tableFormules.methode_insertKeyGetIndex (_inLexique, var_cas_nomFormule, var_cas_numero, var_cas_listeArgFormelsBool, var_cas_unusedBDD SOURCE_FILE_AT_LINE (505)) ;
  GGS_typeFormule  var_cas_f ;
  GGS_typeTableVariablesBool  var_cas_tableVariablesLocales ;
  var_cas_tableVariablesLocales = var_cas_tableVariables ;
  nt_formule_ (_inLexique, var_cas_tableVariablesLocales, var_cas_inBDDslot, var_cas_ioDomainMap, var_cas_tableFormules, var_cas_f) ;
...
pr_facteur_formule_syntaxeBDD_894_23_ (lexiqueBDD & _inLexique,
  ...
  GGS_bdd var_cas_23849 ;
  var_cas_tableFormules.methode_searchKeyGetIndex (_inLexique, var_cas_nom, var_cas_numero, var_cas_listeArgsFormelsBool, var_cas_23849 SOURCE_FILE_AT_LINE (906)) ;
  _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__5B) ;
    ...
    while (syntaxRepeat) {
        ...
        if (var_cas_varDescriptor.isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
            cPtr_typeDirectVariable * operand_24110 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) ;
            macroValidPointer (operand_24110) ; 
            var_cas_listeArgsEffectifsBool.addAssign_operation (operand_24110->mIndex, operand_24110->mBitSize, operand_24110->mLowBound, operand_24110->mHighBound, var_cas_errorLocation) ;
          }else if (dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
            cPtr_typeRecordVariable * operand_24305 = dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) ;
            macroValidPointer (operand_24305) ; 
            ::routine_buildActualArgsList (_inLexique,  operand_24305->mMap,  var_cas_listeArgsEffectifsBool,  var_cas_errorLocation SOURCE_FILE_AT_LINE (917)) ;
          }else{ // Else part
              var_cas_errorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a variable was expected here ; I found ")) + (var_cas_varDescriptor.reader_variableDescriptorErrorMessage (_inLexique SOURCE_FILE_AT_LINE (920)))) SOURCE_FILE_AT_LINE (920)) ;
          }
        }
...
pr_parse_argument_syntaxeBDD_936_22_ (lexiqueBDD & _inLexique,
  ...
  var_cas_ioVarMap.methode_searchKey (_inLexique, var_cas_varName, var_cas_outVarDescriptor SOURCE_FILE_AT_LINE (944)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_syntaxeBDD_13 (_inLexique)) {
        case 2 : {
          ...
          var_cas_fieldMap.methode_searchKey (_inLexique, var_cas_fieldName, var_cas_outVarDescriptor SOURCE_FILE_AT_LINE (955)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
