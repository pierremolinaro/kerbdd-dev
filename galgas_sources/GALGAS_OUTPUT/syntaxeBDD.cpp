...
void routine_exploreRecordDomain (C_lexique & lexique_var_,
  ...
  while (operand_9416 != NULL) {
    ...
    if (operand_9416->mInfo.mDomain.isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectDomain *> (operand_9416->mInfo.mDomain.getPtr ()) != NULL) {
        cPtr_typeDirectDomain * operand_9489 = dynamic_cast <cPtr_typeDirectDomain *> (operand_9416->mInfo.mDomain.getPtr ()) ;
        ...
        var_cas_v = GGS_typeDirectVariable::constructor_new (var_cas_num, operand_9489->mBitsCount, operand_9489->mLowBound, operand_9489->mHighBound) ;
        insertKey_typeTableVariablesBool (lexique_var_,
                                        var_cas_outMap,
                                        operand_9416->mKey,
                                        var_cas_v,
                                        NULL) ;
      }else if (dynamic_cast <cPtr_typeRecordDomain *> (operand_9416->mInfo.mDomain.getPtr ()) != NULL) {
        cPtr_typeRecordDomain * operand_9772 = dynamic_cast <cPtr_typeRecordDomain *> (operand_9416->mInfo.mDomain.getPtr ()) ;
        macroValidPointer (operand_9772) ; 
        GGS_typeTableVariablesBool  var_cas_localMap ;
        ::routine_exploreRecordDomain (lexique_var_,  operand_9772->mRecordMap,  var_cas_localMap,  var_cas_inErrorLocation) ;
        GGS_typeVariableDescriptor  var_cas_v ;
...
void routine_buildFormalArgsList (C_lexique & lexique_var_,
  ...
  if (var_cas_inVariableDescriptor.isBuilt ()) {
    if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_inVariableDescriptor.getPtr ()) != NULL) {
      cPtr_typeDirectVariable * operand_10744 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_inVariableDescriptor.getPtr ()) ;
      macroValidPointer (operand_10744) ; 
      var_cas_ioFormalArgsList.addAssign_operation (operand_10744->mIndex, operand_10744->mBitSize, operand_10744->mLowBound, operand_10744->mHighBound) ;
    ...
    while (syntaxRepeat) {
        ...
        if (var_cas_domain.isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) != NULL) {
            cPtr_typeDirectDomain * operand_11781 = dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) ;
            ...
            GGS_typeVariableDescriptor  var_cas_v ;
            var_cas_v = GGS_typeDirectVariable::constructor_new (var_cas_pipo, operand_11781->mBitsCount, operand_11781->mLowBound, operand_11781->mHighBound) ;
            insertKey_typeTableVariablesBool (lexique_var_,
            ...
            var_cas_listeArgFormelsBool.addAssign_operation (var_cas_num, operand_11781->mBitsCount, operand_11781->mLowBound, operand_11781->mHighBound) ;
          }else if (dynamic_cast <cPtr_typeRecordDomain *> (var_cas_domain.getPtr ()) != NULL) {
            cPtr_typeRecordDomain * operand_12299 = dynamic_cast <cPtr_typeRecordDomain *> (var_cas_domain.getPtr ()) ;
            ...
            ::routine_exploreRecordDomain (lexique_var_,  operand_12299->mRecordMap,  var_cas_recordMap,  var_cas_errorLocation) ;
            GGS_typeVariableDescriptor  var_cas_v ;
...
void routine_buildActualArgsList (C_lexique & lexique_var_,
  ...
  while (operand_25750 != NULL) {
    ...
    if (operand_25750->mInfo.mVariableDescriptor.isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectVariable *> (operand_25750->mInfo.mVariableDescriptor.getPtr ()) != NULL) {
        cPtr_typeDirectVariable * operand_25856 = dynamic_cast <cPtr_typeDirectVariable *> (operand_25750->mInfo.mVariableDescriptor.getPtr ()) ;
        macroValidPointer (operand_25856) ; 
        var_cas_ioActualArgsList.addAssign_operation (operand_25856->mIndex, operand_25856->mBitSize, operand_25856->mLowBound, operand_25856->mHighBound, var_cas_inErrorLocation) ;
      }else if (dynamic_cast <cPtr_typeRecordVariable *> (operand_25750->mInfo.mVariableDescriptor.getPtr ()) != NULL) {
        cPtr_typeRecordVariable * operand_26063 = dynamic_cast <cPtr_typeRecordVariable *> (operand_25750->mInfo.mVariableDescriptor.getPtr ()) ;
        macroValidPointer (operand_26063) ; 
        ::routine_buildActualArgsList (lexique_var_,  operand_26063->mMap,  var_cas_ioActualArgsList,  var_cas_inErrorLocation) ;
      }else{ // Else part
          ...
          case 1 : {
            if (var_cas_varDescriptor.isBuilt ()) {
              if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
                cPtr_typeDirectVariable * operand_27115 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) ;
                macroValidPointer (operand_27115) ; 
                var_cas_listeArgsEffectifsBool.addAssign_operation (operand_27115->mIndex, operand_27115->mBitSize, operand_27115->mLowBound, operand_27115->mHighBound, var_cas_errorLocation) ;
              }else if (dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
                cPtr_typeRecordVariable * operand_27314 = dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) ;
                macroValidPointer (operand_27314) ; 
                ::routine_buildActualArgsList (lexique_var_,  operand_27314->mMap,  var_cas_listeArgsEffectifsBool,  var_cas_errorLocation) ;
              }else{ // Else part
