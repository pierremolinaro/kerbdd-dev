...
void routine_exploreRecordDomain (C_Lexique & lexique_var_,
  ...
  GGS_typeDomainMap::element_type * operand_9409 = var_cas_inRecordMap.firstObject () ;
  while ((operand_9409 != NULL)) {
    macroValidPointer (operand_9409) ;
    if (operand_9409->mInfo.mDomain.isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectDomain *> (operand_9409->mInfo.mDomain.getPtr ()) != NULL) {
        cPtr_typeDirectDomain * operand_9485 = dynamic_cast <cPtr_typeDirectDomain *> (operand_9409->mInfo.mDomain.getPtr ()) ;
        macroValidPointer (operand_9485) ; 
        ...
        var_cas_v = GGS_typeDirectVariable::constructor_new (var_cas_num, operand_9485->mBitsCount, operand_9485->mLowBound, operand_9485->mHighBound) ;
        insertKey_typeTableVariablesBool (lexique_var_,
                                        var_cas_outMap,
                                        operand_9409->mKey,
                                        var_cas_v,
                                        NULL) ;
      }else if (dynamic_cast <cPtr_typeRecordDomain *> (operand_9409->mInfo.mDomain.getPtr ()) != NULL) {
        cPtr_typeRecordDomain * operand_9768 = dynamic_cast <cPtr_typeRecordDomain *> (operand_9409->mInfo.mDomain.getPtr ()) ;
        macroValidPointer (operand_9768) ; 
        GGS_typeTableVariablesBool  var_cas_localMap ;
        ::routine_exploreRecordDomain (lexique_var_,  operand_9768->mRecordMap,  var_cas_localMap,  var_cas_inErrorLocation) ;
        GGS_typeVariableDescriptor  var_cas_v ;
        ...
        insertKey_typeTableVariablesBool (lexique_var_,
          ...
          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((GGS_string (true, "a domain was expected here ; I found ")) + (operand_9409->mInfo.mDomain.reader_messageDomainType ()))) ;
      }
    }
    operand_9409 = operand_9409->nextObject () ;
  }
}
...
void routine_buildFormalArgsList (C_Lexique & lexique_var_,
  ...
  if (var_cas_inVariableDescriptor.isBuilt ()) {
    if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_inVariableDescriptor.getPtr ()) != NULL) {
      cPtr_typeDirectVariable * operand_10740 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_inVariableDescriptor.getPtr ()) ;
      macroValidPointer (operand_10740) ; 
      var_cas_ioFormalArgsList.addAssign_operation (operand_10740->mIndex, operand_10740->mBitSize, operand_10740->mLowBound, operand_10740->mHighBound) ;
    }else if (dynamic_cast <cPtr_typeRecordVariable *> (var_cas_inVariableDescriptor.getPtr ()) != NULL) {
      cPtr_typeRecordVariable * operand_10926 = dynamic_cast <cPtr_typeRecordVariable *> (var_cas_inVariableDescriptor.getPtr ()) ;
      macroValidPointer (operand_10926) ; 
      GGS_typeTableVariablesBool::element_type * operand_11023 = operand_10926->mMap.firstObject () ;
      while ((operand_11023 != NULL)) {
        macroValidPointer (operand_11023) ;
        ::routine_buildFormalArgsList (lexique_var_,  operand_11023->mInfo.mVariableDescriptor,  var_cas_ioFormalArgsList,  var_cas_inErrorLocation) ;
        operand_11023 = operand_11023->nextObject () ;
      }
    }else{ // Else part
    ...
    while (syntaxRepeat) {
        ...
        if (var_cas_domain.isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) != NULL) {
            cPtr_typeDirectDomain * operand_11773 = dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) ;
            macroValidPointer (operand_11773) ; 
            GGS_luint  var_cas_num ;
            GGS_luint  var_cas_pipo ;
            var_cas_pipo = GGS_luint::constructor_new (GGS_uint (true, 0UL), GGS_location (lexique_var_)) ;
            GGS_typeVariableDescriptor  var_cas_v ;
            var_cas_v = GGS_typeDirectVariable::constructor_new (var_cas_pipo, operand_11773->mBitsCount, operand_11773->mLowBound, operand_11773->mHighBound) ;
            insertKey_typeTableVariablesBool (lexique_var_,
            ...
            var_cas_listeArgFormelsBool.addAssign_operation (var_cas_num, operand_11773->mBitsCount, operand_11773->mLowBound, operand_11773->mHighBound) ;
          }else if (dynamic_cast <cPtr_typeRecordDomain *> (var_cas_domain.getPtr ()) != NULL) {
            cPtr_typeRecordDomain * operand_12291 = dynamic_cast <cPtr_typeRecordDomain *> (var_cas_domain.getPtr ()) ;
            macroValidPointer (operand_12291) ; 
            ...
            ::routine_exploreRecordDomain (lexique_var_,  operand_12291->mRecordMap,  var_cas_recordMap,  var_cas_errorLocation) ;
            GGS_typeVariableDescriptor  var_cas_v ;
...
void routine_buildActualArgsList (C_Lexique & lexique_var_,
                                ...
                                const GGS_location  & var_cas_inErrorLocation) {
  GGS_typeTableVariablesBool::element_type * operand_25735 = var_cas_inDomainMap.firstObject () ;
  while ((operand_25735 != NULL)) {
    macroValidPointer (operand_25735) ;
    if (operand_25735->mInfo.mVariableDescriptor.isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectVariable *> (operand_25735->mInfo.mVariableDescriptor.getPtr ()) != NULL) {
        cPtr_typeDirectVariable * operand_25844 = dynamic_cast <cPtr_typeDirectVariable *> (operand_25735->mInfo.mVariableDescriptor.getPtr ()) ;
        macroValidPointer (operand_25844) ; 
        var_cas_ioActualArgsList.addAssign_operation (operand_25844->mIndex, operand_25844->mBitSize, operand_25844->mLowBound, operand_25844->mHighBound, var_cas_inErrorLocation) ;
      }else if (dynamic_cast <cPtr_typeRecordVariable *> (operand_25735->mInfo.mVariableDescriptor.getPtr ()) != NULL) {
        cPtr_typeRecordVariable * operand_26051 = dynamic_cast <cPtr_typeRecordVariable *> (operand_25735->mInfo.mVariableDescriptor.getPtr ()) ;
        macroValidPointer (operand_26051) ; 
        ::routine_buildActualArgsList (lexique_var_,  operand_26051->mMap,  var_cas_ioActualArgsList,  var_cas_inErrorLocation) ;
      }else{ // Else part
          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((GGS_string (true, "a variable was expected here ; I found ")) + (operand_25735->mInfo.mVariableDescriptor.reader_variableDescriptorErrorMessage ()))) ;
      }
    }
    operand_25735 = operand_25735->nextObject () ;
  }
}
          ...
          case 1 : {
            if (var_cas_varDescriptor.isBuilt ()) {
              if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
                cPtr_typeDirectVariable * operand_27103 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) ;
                macroValidPointer (operand_27103) ; 
                var_cas_listeArgsEffectifsBool.addAssign_operation (operand_27103->mIndex, operand_27103->mBitSize, operand_27103->mLowBound, operand_27103->mHighBound, var_cas_errorLocation) ;
              }else if (dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
                cPtr_typeRecordVariable * operand_27302 = dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) ;
                macroValidPointer (operand_27302) ; 
                ::routine_buildActualArgsList (lexique_var_,  operand_27302->mMap,  var_cas_listeArgsEffectifsBool,  var_cas_errorLocation) ;
              }else{ // Else part
