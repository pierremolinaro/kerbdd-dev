...
pr_facteur_formule_syntaxeBDD_894_23_ (lexiqueBDD & _inLexique,
  ...
  GGS_bdd var_cas_23916 ;
  if (var_cas_tableFormules.isBuilt ()) {
    var_cas_tableFormules (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_nom, var_cas_numero, var_cas_listeArgsFormelsBool, var_cas_23916 SOURCE_FILE_AT_LINE (906)) ;
  }
  _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__5B) ;
    ...
    while (syntaxRepeat) {
        ...
        if (var_cas_varDescriptor.isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
            cPtr_typeDirectVariable * operand_24181 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) ;
            macroValidPointer (operand_24181) ; 
            var_cas_listeArgsEffectifsBool.addAssign_operation (operand_24181->mIndex, operand_24181->mBitSize, operand_24181->mLowBound, operand_24181->mHighBound, var_cas_errorLocation) ;
          }else if (dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
            cPtr_typeRecordVariable * operand_24376 = dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) ;
            macroValidPointer (operand_24376) ; 
            ::routine_buildActualArgsList (_inLexique,  operand_24376->mMap,  var_cas_listeArgsEffectifsBool,  var_cas_errorLocation SOURCE_FILE_AT_LINE (917)) ;
          }else{ // Else part
