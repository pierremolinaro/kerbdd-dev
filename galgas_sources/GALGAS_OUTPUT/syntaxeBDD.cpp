    ...
    while (syntaxRepeat) {
      switch (select_repeat_syntaxeBDD_0 (_inLexique)) {
        ...
        case 11 : {
          ...
          var_cas_afficherBDD = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 1), GGS_location (_inLexique) COMMA_HERE) ;
        ...
        case 12 : {
          ...
          GGS_luint  var_cas_afficherBDD ;
          var_cas_afficherBDD = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 2), GGS_location (_inLexique) COMMA_HERE) ;
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__23) ;
          nt_analyserFormule_ (_inLexique, var_cas_tableFormules, var_cas_ioDomainMap, var_cas_listeCalculs, var_cas_afficherBDD) ;
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__3B) ;
          } break ;
        case 13 : {
          ...
          GGS_luint  var_cas_afficherBDD ;
          var_cas_afficherBDD = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 3), GGS_location (_inLexique) COMMA_HERE) ;
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__23) ;
          nt_analyserFormule_ (_inLexique, var_cas_tableFormules, var_cas_ioDomainMap, var_cas_listeCalculs, var_cas_afficherBDD) ;
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__3B) ;
          } break ;
        case 14 : {
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__23) ;
          GGS_luint  var_cas_afficherBDD ;
          var_cas_afficherBDD = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 0), GGS_location (_inLexique) COMMA_HERE) ;
          nt_analyserFormule_ (_inLexique, var_cas_tableFormules, var_cas_ioDomainMap, var_cas_listeCalculs, var_cas_afficherBDD) ;
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__3B) ;
          } break ;
        default :
    ...
    case 1 : {
      ...
      switch (select_syntaxeBDD_2 (_inLexique)) {
        ...
        case 2 : {
          ...
          var_cas_lowBound = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 0), GGS_location (_inLexique) COMMA_HERE) ;
          switch (select_syntaxeBDD_3 (_inLexique)) {
            case 1 : {
              var_cas_highBound = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 1), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 2 : {
...
pr_argsFormelsFormule_syntaxeBDD_311_26_ (lexiqueBDD & _inLexique,
  ...
  var_cas_outBDDslot = GGS_uint (true, 0) ;
  ...
  switch (select_syntaxeBDD_7 (_inLexique)) {
    case 1 : {
      ...
      switch (select_syntaxeBDD_8 (_inLexique)) {
        case 1 : {
          var_cas_highBound = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 1), GGS_location (_inLexique) COMMA_HERE) ;
          var_cas_dim = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 1), GGS_location (_inLexique) COMMA_HERE) ;
          } break ;
        case 2 : {
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__5B) ;
          _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1_nombre) ;
