  ...
  while ((operand_8352 != NULL)) {
    ...
    if (operand_8352->mInfo.mDomain.isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectDomain *> (operand_8352->mInfo.mDomain.getPtr ()) != NULL) {
        ...
        var_cas_ioBDDslot = var_cas_ioBDDslot.add_operation (_inLexique, operand_8428->mBitsCount.reader_value () SOURCE_FILE_AT_LINE (349)) ;
         ;
        ...
        var_cas_outMap.methode_insertKey (_inLexique, operand_8352->mKey, var_cas_v SOURCE_FILE_AT_LINE (354)) ;
          ...
          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((GGS_string (true, "a domain was expected here ; I found ")) + (operand_8352->mInfo.mDomain.reader_messageDomainType ())) SOURCE_FILE_AT_LINE (356)) ;
      }
    }
    ...
    while (syntaxRepeat) {
        ...
        if (var_cas_domain.isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) != NULL) {
            ...
            var_cas_ioBDDslot = var_cas_ioBDDslot.add_operation (_inLexique, operand_9659->mBitsCount.reader_value () SOURCE_FILE_AT_LINE (380)) ;
             ;
            ...
            ::routine_buildFormalArgsList (_inLexique,  var_cas_v,  var_cas_listeArgFormelsBool,  var_cas_errorLocation SOURCE_FILE_AT_LINE (390)) ;
              ...
              var_cas_nom.reader_location ().signalGGSSemanticError (_inLexique, ((GGS_string (true, "a domain was expected here ; I found ")) + (var_cas_domain.reader_messageDomainType ())) SOURCE_FILE_AT_LINE (392)) ;
          }
        }
        ...
        if (var_cas_varDescriptor.isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
            ...
            ::routine_buildActualArgsList (_inLexique,  operand_24305->mMap,  var_cas_listeArgsEffectifsBool,  var_cas_errorLocation SOURCE_FILE_AT_LINE (917)) ;
              ...
              var_cas_errorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((GGS_string (true, "a variable was expected here ; I found ")) + (var_cas_varDescriptor.reader_variableDescriptorErrorMessage ())) SOURCE_FILE_AT_LINE (920)) ;
          }
        }
