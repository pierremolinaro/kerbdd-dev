    ...
    if (operand_8461->mInfo.mDomain._isBuilt ()) {
      ...
      if (operand_8533 != NULL) {
        ...
        if (operand_8866 != NULL) {
          ...
          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a domain was expected here ; I found ")) + (operand_8461->mInfo.mDomain.reader_messageDomainType (_inLexique SOURCE_FILE_AT_LINE (356)))) SOURCE_FILE_AT_LINE (357)) ;
        }
      }
    }
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (var_cas_domain._isBuilt ()) {
          cPtr_typeDirectDomain * operand_9759 = dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) ;
          if (operand_9759 != NULL) {
            macroValidPointer (operand_9759) ; 
            GGS_luint  var_cas_slot ;
            var_cas_slot = GGS_luint::constructor_new (_inLexique, var_cas_ioBDDslot, GGS_location (_inLexique) COMMA_HERE) ;
            GGS_typeVariableDescriptor  var_cas_v ;
            var_cas_v = GGS_typeDirectVariable::constructor_new (_inLexique, var_cas_slot, operand_9759->mBitsCount, operand_9759->mLowBound, operand_9759->mHighBound COMMA_HERE) ;
            var_cas_tableVariables.modifier_insertKey (_inLexique, var_cas_nom, var_cas_v SOURCE_FILE_AT_LINE (379)) ;
            var_cas_ioBDDslot = var_cas_ioBDDslot._add_operation (_inLexique, operand_9759->mBitsCount.reader_uint (_inLexique SOURCE_FILE_AT_LINE (380)) SOURCE_FILE_AT_LINE (380)) ;
            ...
            var_cas_listeArgFormelsBool._addAssign_operation (var_cas_num, operand_9759->mBitsCount, operand_9759->mLowBound, operand_9759->mHighBound) ;
          }else{
            cPtr_typeRecordDomain * operand_10262 = dynamic_cast <cPtr_typeRecordDomain *> (var_cas_domain.getPtr ()) ;
            if (operand_10262 != NULL) {
              ...
              ::routine_exploreRecordDomain (_inLexique,  operand_10262->mRecordMap,  var_cas_recordMap,  var_cas_ioBDDslot,  var_cas_errorLocation SOURCE_FILE_AT_LINE (387)) ;
              GGS_typeVariableDescriptor  var_cas_v ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (var_cas_varDescriptor._isBuilt ()) {
          cPtr_typeDirectVariable * operand_24292 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) ;
          if (operand_24292 != NULL) {
            macroValidPointer (operand_24292) ; 
            var_cas_listeArgsEffectifsBool._addAssign_operation (operand_24292->mIndex, operand_24292->mBitSize, operand_24292->mLowBound, operand_24292->mHighBound, var_cas_errorLocation) ;
          }else{
            cPtr_typeRecordVariable * operand_24479 = dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) ;
            if (operand_24479 != NULL) {
              macroValidPointer (operand_24479) ; 
              ::routine_buildActualArgsList (_inLexique,  operand_24479->mMap,  var_cas_listeArgsEffectifsBool,  var_cas_errorLocation SOURCE_FILE_AT_LINE (917)) ;
            }else{ // Else part
