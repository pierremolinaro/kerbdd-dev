...
void syntaxeBDD::
pr_axiomeBDD_syntaxeBDD_121_16_ (lexiqueBDD & inLexique,
...
void syntaxeBDD::
pr_domainDefinition_syntaxeBDD_224_23_ (lexiqueBDD & inLexique,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
  ...
  switch (select_syntaxeBDD_1 (inLexique)) {
    ...
    case 3 : {
      ...
      inLexique.assignFromAttribute_att_token (var_cas_domainName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_id) COMMA_HERE) ;
      const GGS_typeDomainMap  temp_6579 = var_cas_ioDomainMap ;
      if (temp_6579.isBuilt ()) {
        temp_6579 (HERE)->method_searchKey (inLexique, var_cas_domainName, var_cas_outDomain COMMA_SOURCE_FILE_AT_LINE (270)) ;
      }
      } break ;
    default :
      break ;
...
void syntaxeBDD::
pr_analyserFormule_syntaxeBDD_278_22_ (lexiqueBDD & inLexique,
                                GGS_typeTableFormules  &var_cas_tableFormules,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeListeCalculs  &var_cas_listeCalculs,
                                GGS_luint  var_cas_afficherBDD) {
...
void syntaxeBDD::
pr_argsFormelsFormule_syntaxeBDD_313_25_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  &var_cas_tableVariables,
...
void routine_exploreRecordDomain (C_Compiler & inLexique,
  ...
  {
    GGS_typeDomainMap::cEnumerator enumerator_8488 (var_cas_inRecordMap, true) ;
    const GGS_typeDomainMap::cElement * operand_8488 = NULL ;
    while (((operand_8488 = enumerator_8488.nextObject ()))) {
      macroValidPointer (operand_8488) ;
      { const GGS_typeDomain _var_9307 = operand_8488->mInfo.mDomain ; // CAST instruction
        if (_var_9307.getPtr () != NULL) {
          macroValidPointer (_var_9307.getPtr ()) ;
          if (dynamic_cast <cPtr_typeDirectDomain *> (_var_9307.getPtr ()) != NULL) {
            const GGS_typeDirectDomain var_cas_dd (_var_9307.getPtr ()) ;
            ...
            var_cas_outMap.modifier_insertKey (inLexique, operand_8488->mKey, var_cas_v COMMA_SOURCE_FILE_AT_LINE (350)) ;
          ...
          }else if (dynamic_cast <cPtr_typeRecordDomain *> (_var_9307.getPtr ()) != NULL) {
            const GGS_typeRecordDomain var_cas_rd (_var_9307.getPtr ()) ;
            ...
            var_cas_outMap.modifier_insertKey (inLexique, operand_8488->mKey, var_cas_v COMMA_SOURCE_FILE_AT_LINE (356)) ;
          }else{
            var_cas_inErrorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("a aDomain was expected here ; I found ")).operator_concat (operand_8488->mInfo.mDomain.reader_messageDomainType (inLexique COMMA_SOURCE_FILE_AT_LINE (358))) COMMA_SOURCE_FILE_AT_LINE (359)) ;
          }
        }
      }
    }
...
void syntaxeBDD::
pr_declarations_syntaxeBDD_365_19_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  &var_cas_tableVariables,
                                GGS_uint  &var_cas_ioBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeFormalArgumentsList  &var_cas_listeArgFormelsBool) {
  ...
  { bool syntaxRepeat_6 = true ;
    while (syntaxRepeat_6) {
        ...
        { const GGS_typeDomain _var_11820 = var_cas_aDomain ; // CAST instruction
          if (_var_11820.getPtr () != NULL) {
            macroValidPointer (_var_11820.getPtr ()) ;
            if (dynamic_cast <cPtr_typeDirectDomain *> (_var_11820.getPtr ()) != NULL) {
              const GGS_typeDirectDomain var_cas_dd (_var_11820.getPtr ()) ;
              GGS_luint  var_cas_slot = GGS_luint ::constructor_new (inLexique, var_cas_ioBDDslot, GGS_location (inLexique) COMMA_HERE) ;
              ...
              { const GGS_typeVariableDescriptor _var_10349 = var_cas_v ; // CAST instruction
                if (_var_10349.getPtr () != NULL) {
                  macroValidPointer (_var_10349.getPtr ()) ;
                  if (dynamic_cast <cPtr_typeDirectVariable *> (_var_10349.getPtr ()) != NULL) {
                    const GGS_typeDirectVariable var_cas_dv (_var_10349.getPtr ()) ;
                  ...
                  var_cas_nom.castDefaultErrorMessage (inLexique, _castBranchDescriptor, 1, & typeid (* (_var_10349.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (387)) ;
                  }
                }
              }
            }else if (dynamic_cast <cPtr_typeRecordDomain *> (_var_11820.getPtr ()) != NULL) {
              const GGS_typeRecordDomain var_cas_rd (_var_11820.getPtr ()) ;
...
void syntaxeBDD::
pr_dimension_syntaxeBDD_423_16_ (lexiqueBDD & inLexique,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeDomain  &var_cas_outDomain) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__3A_) COMMA_HERE) ;
  switch (select_syntaxeBDD_7 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.assignFromAttribute_att_token (var_cas_domainName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_id) COMMA_HERE) ;
      const GGS_typeDomainMap  temp_12625 = var_cas_ioDomainMap ;
      if (temp_12625.isBuilt ()) {
        temp_12625 (HERE)->method_searchKey (inLexique, var_cas_domainName, var_cas_outDomain COMMA_SOURCE_FILE_AT_LINE (446)) ;
      }
      } break ;
    default :
      break ;
...
void syntaxeBDD::
pr_type_formule_syntaxeBDD_454_19_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
...
void syntaxeBDD::
pr_type_formule_syntaxeBDD_482_19_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_type_formule_syntaxeBDD_511_19_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_formule_syntaxeBDD_543_14_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_egalite_formule_syntaxeBDD_590_22_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_terme_formule_syntaxeBDD_624_20_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_657_22_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_677_22_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  /* var_cas_tableVariables */,
                                GGS_uint  /* var_cas_inBDDslot */,
                                GGS_typeDomainMap  &/* var_cas_ioDomainMap */,
                                GGS_typeTableFormules  &/* var_cas_tableFormules */,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_690_22_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  /* var_cas_inBDDslot */,
                                GGS_typeDomainMap  &/* var_cas_ioDomainMap */,
                                GGS_typeTableFormules  &/* var_cas_tableFormules */,
...
void syntaxeBDD::
pr_comparaisonVariable_syntaxeBDD_716_26_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  /* var_cas_tableVariables */,
...
void syntaxeBDD::
pr_comparaisonVariable_syntaxeBDD_733_26_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_756_22_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  /* var_cas_tableVariables */,
                                GGS_uint  /* var_cas_inBDDslot */,
                                GGS_typeDomainMap  &/* var_cas_ioDomainMap */,
                                GGS_typeTableFormules  &/* var_cas_tableFormules */,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_769_22_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_790_22_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_830_22_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_864_22_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_895_22_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  /* var_cas_inBDDslot */,
                                GGS_typeDomainMap  &/* var_cas_ioDomainMap */,
                                GGS_typeTableFormules  &/* var_cas_tableFormules */,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_914_22_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  /* var_cas_inBDDslot */,
                                GGS_typeDomainMap  &/* var_cas_ioDomainMap */,
                                GGS_typeTableFormules  &var_cas_tableFormules,
  ...
  GGS_extern_bdd automatic_var_25108_0 ;
  const GGS_typeTableFormules  temp_25069 = var_cas_tableFormules ;
  if (temp_25069.isBuilt ()) {
    temp_25069 (HERE)->method_searchKey (inLexique, var_cas_nom, var_cas_numero, var_cas_listeArgsFormelsBool, automatic_var_25108_0 COMMA_SOURCE_FILE_AT_LINE (926)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__5B_) COMMA_HERE) ;
  ...
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
        ...
        { const GGS_typeVariableDescriptor _var_25900 = var_cas_varDescriptor ; // CAST instruction
          if (_var_25900.getPtr () != NULL) {
            macroValidPointer (_var_25900.getPtr ()) ;
            if (dynamic_cast <cPtr_typeDirectVariable *> (_var_25900.getPtr ()) != NULL) {
              const GGS_typeDirectVariable var_cas_dv (_var_25900.getPtr ()) ;
            ...
            }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_25900.getPtr ()) != NULL) {
              const GGS_typeRecordVariable var_cas_rv (_var_25900.getPtr ()) ;
...
void syntaxeBDD::
pr_parse_argument_syntaxeBDD_956_21_ (lexiqueBDD & inLexique,
  ...
  const GGS_typeTableVariablesBool  temp_26623 = var_cas_ioVarMap ;
  if (temp_26623.isBuilt ()) {
    temp_26623 (HERE)->method_searchKey (inLexique, var_cas_varName, var_cas_outVarDescriptor COMMA_SOURCE_FILE_AT_LINE (964)) ;
  }
    ...
    while (syntaxRepeat_13) {
      switch (select_syntaxeBDD_13 (inLexique)) {
        case 2 : {
          ...
          const GGS_typeTableVariablesBool  temp_27106 = var_cas_fieldMap ;
          if (temp_27106.isBuilt ()) {
            temp_27106 (HERE)->method_searchKey (inLexique, var_cas_fieldName, var_cas_outVarDescriptor COMMA_SOURCE_FILE_AT_LINE (976)) ;
          }
          } break ;
        default :
...
void syntaxeBDD::
pr_parse_scalar_argument_syntaxeBDD_982_28_ (lexiqueBDD & inLexique,
                                GGS_typeTableVariablesBool  &var_cas_ioVarMap,
