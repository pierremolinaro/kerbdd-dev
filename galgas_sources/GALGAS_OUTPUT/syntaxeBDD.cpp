  ...
  while ((operand_8363 != NULL)) {
    ...
    if (operand_8363->mInfo.mDomain._isBuilt ()) {
      if (dynamic_cast <cPtr_typeDirectDomain *> (operand_8363->mInfo.mDomain.getPtr ()) != NULL) {
        ...
        var_cas_ioBDDslot = var_cas_ioBDDslot._add_operation (_inLexique, operand_8439->mBitsCount.reader_uint (_inLexique SOURCE_FILE_AT_LINE (349)) SOURCE_FILE_AT_LINE (349)) ;
      }else if (dynamic_cast <cPtr_typeRecordDomain *> (operand_8363->mInfo.mDomain.getPtr ()) != NULL) {
        cPtr_typeRecordDomain * operand_8778 = dynamic_cast <cPtr_typeRecordDomain *> (operand_8363->mInfo.mDomain.getPtr ()) ;
        macroValidPointer (operand_8778) ; 
        GGS_typeTableVariablesBool  var_cas_localMap ;
        ::routine_exploreRecordDomain (_inLexique,  operand_8778->mRecordMap,  var_cas_localMap,  var_cas_ioBDDslot,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (352)) ;
        GGS_typeVariableDescriptor  var_cas_v ;
    ...
    while (syntaxRepeat) {
        ...
        if (var_cas_domain._isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) != NULL) {
            cPtr_typeDirectDomain * operand_9673 = dynamic_cast <cPtr_typeDirectDomain *> (var_cas_domain.getPtr ()) ;
            macroValidPointer (operand_9673) ; 
            GGS_luint  var_cas_slot ;
            var_cas_slot = GGS_luint::constructor_new (_inLexique, var_cas_ioBDDslot, GGS_location (_inLexique) COMMA_HERE) ;
            GGS_typeVariableDescriptor  var_cas_v ;
            var_cas_v = GGS_typeDirectVariable::constructor_new (_inLexique, var_cas_slot, operand_9673->mBitsCount, operand_9673->mLowBound, operand_9673->mHighBound COMMA_HERE) ;
            var_cas_tableVariables.method_insertKey (_inLexique, var_cas_nom, var_cas_v SOURCE_FILE_AT_LINE (379)) ;
            var_cas_ioBDDslot = var_cas_ioBDDslot._add_operation (_inLexique, operand_9673->mBitsCount.reader_uint (_inLexique SOURCE_FILE_AT_LINE (380)) SOURCE_FILE_AT_LINE (380)) ;
            ...
            var_cas_listeArgFormelsBool._addAssign_operation (var_cas_num, operand_9673->mBitsCount, operand_9673->mLowBound, operand_9673->mHighBound) ;
          }else if (dynamic_cast <cPtr_typeRecordDomain *> (var_cas_domain.getPtr ()) != NULL) {
            cPtr_typeRecordDomain * operand_10182 = dynamic_cast <cPtr_typeRecordDomain *> (var_cas_domain.getPtr ()) ;
            ...
            ::routine_exploreRecordDomain (_inLexique,  operand_10182->mRecordMap,  var_cas_recordMap,  var_cas_ioBDDslot,  var_cas_errorLocation SOURCE_FILE_AT_LINE (387)) ;
            GGS_typeVariableDescriptor  var_cas_v ;
...
pr_facteur_formule_syntaxeBDD_894_23_ (lexiqueBDD & _inLexique,
  ...
  GGS_bdd var_cas_23914 ;
  if (var_cas_tableFormules._isBuilt ()) {
    var_cas_tableFormules (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_nom, var_cas_numero, var_cas_listeArgsFormelsBool, var_cas_23914 SOURCE_FILE_AT_LINE (906)) ;
  }
  _inLexique.acceptTerminal (lexiqueBDD::lexiqueBDD_1__5B) ;
    ...
    while (syntaxRepeat) {
        ...
        if (var_cas_varDescriptor._isBuilt ()) {
          if (dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
            cPtr_typeDirectVariable * operand_24179 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) ;
            macroValidPointer (operand_24179) ; 
            var_cas_listeArgsEffectifsBool._addAssign_operation (operand_24179->mIndex, operand_24179->mBitSize, operand_24179->mLowBound, operand_24179->mHighBound, var_cas_errorLocation) ;
          }else if (dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) != NULL) {
            cPtr_typeRecordVariable * operand_24374 = dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) ;
            macroValidPointer (operand_24374) ; 
            ::routine_buildActualArgsList (_inLexique,  operand_24374->mMap,  var_cas_listeArgsEffectifsBool,  var_cas_errorLocation SOURCE_FILE_AT_LINE (917)) ;
          }else{ // Else part
