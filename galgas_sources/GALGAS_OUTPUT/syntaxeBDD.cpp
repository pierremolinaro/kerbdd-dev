  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (var_cas_varDescriptor._isBuilt ()) {
          cPtr_typeDirectVariable * operand_24194 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) ;
          if (operand_24194 != NULL) {
            macroValidPointer (operand_24194) ; 
            var_cas_listeArgsEffectifsBool._addAssign_operation (operand_24194->mIndex, operand_24194->mBitSize, operand_24194->mLowBound, operand_24194->mHighBound, var_cas_errorLocation) ;
          }else{
            cPtr_typeRecordVariable * operand_24381 = dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) ;
            if (operand_24381 != NULL) {
              macroValidPointer (operand_24381) ; 
              ::routine_buildActualArgsList (_inLexique,  operand_24381->mMap,  var_cas_listeArgsEffectifsBool,  var_cas_errorLocation SOURCE_FILE_AT_LINE (917)) ;
            }else{ // Else part
