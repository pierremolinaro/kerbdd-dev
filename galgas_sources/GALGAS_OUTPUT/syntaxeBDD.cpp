...
void routine_exploreRecordDomain (C_Compiler & _inLexique,
  ...
  GGS_typeDomainMap::element_type * operand_8461 = var_cas_inRecordMap.firstObject () ;
  while ((operand_8461 != NULL)) {
    macroValidPointer (operand_8461) ;
    if (operand_8461->mInfo.mDomain._isBuilt ()) {
      cPtr_typeDirectDomain * operand_8533 = dynamic_cast <cPtr_typeDirectDomain *> (operand_8461->mInfo.mDomain.getPtr ()) ;
      if (operand_8533 != NULL) {
        ...
        var_cas_v = GGS_typeDirectVariable::constructor_new (_inLexique, var_cas_slot, operand_8533->mBitsCount, operand_8533->mLowBound, operand_8533->mHighBound COMMA_HERE) ;
        var_cas_outMap.modifier_insertKey (_inLexique, operand_8461->mKey, var_cas_v SOURCE_FILE_AT_LINE (348)) ;
        var_cas_ioBDDslot = var_cas_ioBDDslot._add_operation (_inLexique, operand_8533->mBitsCount.reader_uint (_inLexique SOURCE_FILE_AT_LINE (349)) SOURCE_FILE_AT_LINE (349)) ;
      }else{
        cPtr_typeRecordDomain * operand_8866 = dynamic_cast <cPtr_typeRecordDomain *> (operand_8461->mInfo.mDomain.getPtr ()) ;
        if (operand_8866 != NULL) {
          macroValidPointer (operand_8866) ; 
          GGS_typeTableVariablesBool  var_cas_localMap ;
          ::routine_exploreRecordDomain (_inLexique, operand_8866->mRecordMap, var_cas_localMap, var_cas_ioBDDslot, var_cas_inErrorLocation SOURCE_FILE_AT_LINE (352)) ;
          GGS_typeVariableDescriptor  var_cas_v ;
          var_cas_v = GGS_typeRecordVariable::constructor_new (_inLexique, var_cas_localMap COMMA_HERE) ;
          var_cas_outMap.modifier_insertKey (_inLexique, operand_8461->mKey, var_cas_v SOURCE_FILE_AT_LINE (354)) ;
        }else{ // Else part
          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a aDomain was expected here ; I found ")) + (operand_8461->mInfo.mDomain.reader_messageDomainType (_inLexique SOURCE_FILE_AT_LINE (356)))) SOURCE_FILE_AT_LINE (357)) ;
        }
      }
    }
    operand_8461 = operand_8461->nextObject () ;
  }
  #ifdef DEBUG_TRACE_ENABLED
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (var_cas_aDomain._isBuilt ()) {
          cPtr_typeDirectDomain * operand_9763 = dynamic_cast <cPtr_typeDirectDomain *> (var_cas_aDomain.getPtr ()) ;
          if (operand_9763 != NULL) {
            macroValidPointer (operand_9763) ; 
            GGS_luint  var_cas_slot ;
            var_cas_slot = GGS_luint::constructor_new (_inLexique, var_cas_ioBDDslot, GGS_location (_inLexique) COMMA_HERE) ;
            GGS_typeVariableDescriptor  var_cas_v ;
            var_cas_v = GGS_typeDirectVariable::constructor_new (_inLexique, var_cas_slot, operand_9763->mBitsCount, operand_9763->mLowBound, operand_9763->mHighBound COMMA_HERE) ;
            var_cas_tableVariables.modifier_insertKey (_inLexique, var_cas_nom, var_cas_v SOURCE_FILE_AT_LINE (379)) ;
            var_cas_ioBDDslot = var_cas_ioBDDslot._add_operation (_inLexique, operand_9763->mBitsCount.reader_uint (_inLexique SOURCE_FILE_AT_LINE (380)) SOURCE_FILE_AT_LINE (380)) ;
            ...
            var_cas_listeArgFormelsBool._addAssign_operation (var_cas_num, operand_9763->mBitsCount, operand_9763->mLowBound, operand_9763->mHighBound) ;
          }else{
            cPtr_typeRecordDomain * operand_10266 = dynamic_cast <cPtr_typeRecordDomain *> (var_cas_aDomain.getPtr ()) ;
            if (operand_10266 != NULL) {
              macroValidPointer (operand_10266) ; 
              ...
              ::routine_exploreRecordDomain (_inLexique, operand_10266->mRecordMap, var_cas_recordMap, var_cas_ioBDDslot, var_cas_errorLocation SOURCE_FILE_AT_LINE (387)) ;
              GGS_typeVariableDescriptor  var_cas_v ;
              ...
              var_cas_nom.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "a aDomain was expected here ; I found ")) + (var_cas_aDomain.reader_messageDomainType (_inLexique SOURCE_FILE_AT_LINE (392)))) SOURCE_FILE_AT_LINE (393)) ;
            }
          }
        }
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (var_cas_varDescriptor._isBuilt ()) {
          cPtr_typeDirectVariable * operand_24298 = dynamic_cast <cPtr_typeDirectVariable *> (var_cas_varDescriptor.getPtr ()) ;
          if (operand_24298 != NULL) {
            macroValidPointer (operand_24298) ; 
            var_cas_listeArgsEffectifsBool._addAssign_operation (operand_24298->mIndex, operand_24298->mBitSize, operand_24298->mLowBound, operand_24298->mHighBound, var_cas_errorLocation) ;
          }else{
            cPtr_typeRecordVariable * operand_24485 = dynamic_cast <cPtr_typeRecordVariable *> (var_cas_varDescriptor.getPtr ()) ;
            if (operand_24485 != NULL) {
              macroValidPointer (operand_24485) ; 
              ::routine_buildActualArgsList (_inLexique, operand_24485->mMap, var_cas_listeArgsEffectifsBool, var_cas_errorLocation SOURCE_FILE_AT_LINE (917)) ;
            }else{ // Else part
