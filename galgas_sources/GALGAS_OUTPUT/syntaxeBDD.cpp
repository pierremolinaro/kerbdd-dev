            ...
            if (dynamic_cast <cPtr_typeDirectDomain *> (_var_11820.getPtr ()) != NULL) {
              ...
              { const GGS_typeVariableDescriptor _var_10349 = var_cas_v ; // CAST instruction
                if (_var_10349.getPtr () != NULL) {
                  ...
                  var_cas_nom._castDefaultErrorMessage (inLexique, _castBranchDescriptor, 1, & typeid (* (_var_10349.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (387)) ;
                  }
                }
              }
...
pr_type_formule_syntaxeBDD_454_19_ (lexiqueBDD & inLexique,
  ...
  var_cas_tableFormules.modifier_insertKeyGetIndex (inLexique, var_cas_nomFormule, var_cas_numero, var_cas_listeArgFormelsBool, var_cas_unusedBDD COMMA_SOURCE_FILE_AT_LINE (476)) ;
...
pr_type_formule_syntaxeBDD_482_19_ (lexiqueBDD & inLexique,
  ...
  GGS_luint  var_cas_numero ;
  GGS_extern_bdd var_cas_unusedBDD = GGS_extern_bdd::constructor_empty (inLexique COMMA_HERE) ;
  var_cas_tableFormules.modifier_insertKeyGetIndex (inLexique, var_cas_nomFormule, var_cas_numero, var_cas_listeArgFormelsBool, var_cas_unusedBDD COMMA_SOURCE_FILE_AT_LINE (496)) ;
  GGS_typeFormule  var_cas_f ;
  GGS_typeTableVariablesBool  var_cas_tableVariablesLocales = var_cas_tableVariables ;
  nt_formule_ (inLexique, var_cas_tableVariablesLocales, var_cas_inBDDslot, var_cas_ioDomainMap, var_cas_tableFormules, var_cas_f) ;
...
pr_type_formule_syntaxeBDD_511_19_ (lexiqueBDD & inLexique,
  ...
  GGS_luint  var_cas_numero ;
  GGS_extern_bdd var_cas_unusedBDD = GGS_extern_bdd::constructor_empty (inLexique COMMA_HERE) ;
  var_cas_tableFormules.modifier_insertKeyGetIndex (inLexique, var_cas_nomFormule, var_cas_numero, var_cas_listeArgFormelsBool, var_cas_unusedBDD COMMA_SOURCE_FILE_AT_LINE (525)) ;
  GGS_typeFormule  var_cas_f ;
...
pr_facteur_formule_syntaxeBDD_914_22_ (lexiqueBDD & inLexique,
  ...
  const GGS_typeTableFormules  temp_25012 = var_cas_tableFormules ;
  if (temp_25012.isBuilt ()) {
    temp_25012 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_nom, var_cas_numero, var_cas_listeArgsFormelsBool, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (926)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__5B_) COMMA_HERE) ;
  ...
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
        ...
        { const GGS_typeVariableDescriptor _var_25843 = var_cas_varDescriptor ; // CAST instruction
          if (_var_25843.getPtr () != NULL) {
            macroValidPointer (_var_25843.getPtr ()) ;
            if (dynamic_cast <cPtr_typeDirectVariable *> (_var_25843.getPtr ()) != NULL) {
              const GGS_typeDirectVariable var_cas_dv (_var_25843.getPtr ()) ;
            ...
            }else if (dynamic_cast <cPtr_typeRecordVariable *> (_var_25843.getPtr ()) != NULL) {
              const GGS_typeRecordVariable var_cas_rv (_var_25843.getPtr ()) ;
...
pr_parse_argument_syntaxeBDD_956_21_ (lexiqueBDD & inLexique,
  ...
  const GGS_typeTableVariablesBool  temp_26566 = var_cas_ioVarMap ;
  if (temp_26566.isBuilt ()) {
    temp_26566 (HERE)->method_searchKey (inLexique, var_cas_varName, var_cas_outVarDescriptor COMMA_SOURCE_FILE_AT_LINE (964)) ;
  }
    ...
    while (syntaxRepeat_13) {
      switch (select_syntaxeBDD_13 (inLexique)) {
        case 2 : {
          ...
          const GGS_typeTableVariablesBool  temp_27049 = var_cas_fieldMap ;
          if (temp_27049.isBuilt ()) {
            temp_27049 (HERE)->method_searchKey (inLexique, var_cas_fieldName, var_cas_outVarDescriptor COMMA_SOURCE_FILE_AT_LINE (976)) ;
          }
          } break ;
        default :
