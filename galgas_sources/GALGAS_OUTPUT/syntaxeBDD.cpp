...
pr_domainDefinition_syntaxeBDD_222_23_ (lexiqueBDD & inLexique,
  ...
  switch (select_syntaxeBDD_1 (inLexique)) {
    ...
    case 3 : {
      ...
      inLexique.assignFromAttribute_att_token (var_cas_domainName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_id) COMMA_HERE) ;
      const GGS_typeDomainMap  temp_6537 = var_cas_ioDomainMap ;
      if (temp_6537.isBuilt ()) {
        temp_6537 (HERE)->method_searchKey (inLexique, var_cas_domainName, var_cas_outDomain COMMA_SOURCE_FILE_AT_LINE (268)) ;
      }
      } break ;
    default :
      break ;
...
pr_dimension_syntaxeBDD_421_16_ (lexiqueBDD & inLexique,
  ...
  switch (select_syntaxeBDD_7 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.assignFromAttribute_att_token (var_cas_domainName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1_id) COMMA_HERE) ;
      const GGS_typeDomainMap  temp_12627 = var_cas_ioDomainMap ;
      if (temp_12627.isBuilt ()) {
        temp_12627 (HERE)->method_searchKey (inLexique, var_cas_domainName, var_cas_outDomain COMMA_SOURCE_FILE_AT_LINE (444)) ;
      }
      } break ;
    default :
      break ;
...
pr_facteur_formule_syntaxeBDD_912_22_ (lexiqueBDD & inLexique,
  ...
  const GGS_typeTableFormules  temp_25014 = var_cas_tableFormules ;
  if (temp_25014.isBuilt ()) {
    temp_25014 (HERE)->method_searchKeyGetIndex (inLexique, var_cas_nom, var_cas_numero, var_cas_listeArgsFormelsBool, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (924)) ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__5B_) COMMA_HERE) ;
...
pr_parse_argument_syntaxeBDD_954_21_ (lexiqueBDD & inLexique,
  ...
  const GGS_typeTableVariablesBool  temp_26568 = var_cas_ioVarMap ;
  if (temp_26568.isBuilt ()) {
    temp_26568 (HERE)->method_searchKey (inLexique, var_cas_varName, var_cas_outVarDescriptor COMMA_SOURCE_FILE_AT_LINE (962)) ;
  }
    ...
    while (syntaxRepeat_13) {
      switch (select_repeat_syntaxeBDD_13 (inLexique)) {
        case 2 : {
          ...
          const GGS_typeTableVariablesBool  temp_27051 = var_cas_fieldMap ;
          if (temp_27051.isBuilt ()) {
            temp_27051 (HERE)->method_searchKey (inLexique, var_cas_fieldName, var_cas_outVarDescriptor COMMA_SOURCE_FILE_AT_LINE (974)) ;
          }
          } break ;
        default :
