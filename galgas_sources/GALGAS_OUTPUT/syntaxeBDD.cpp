...
void syntaxeBDD::
pr_axiomeBDD_syntaxeBDD_119_16_ (lexiqueBDD & _inLexique,
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_syntaxeBDD_0 (_inLexique)) {
        ...
        case 11 : {
          ...
          var_cas_afficherBDD = GGS_luint ::constructor_new (_inLexique, GGS_uint (1U), GGS_location (_inLexique) COMMA_HERE) ;
        ...
        case 12 : {
          ...
          GGS_luint  var_cas_afficherBDD ;
          var_cas_afficherBDD = GGS_luint ::constructor_new (_inLexique, GGS_uint (2U), GGS_location (_inLexique) COMMA_HERE) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__23) COMMA_HERE) ;
          nt_analyserFormule_ (_inLexique, var_cas_tableFormules, var_cas_ioDomainMap, var_cas_listeCalculs, var_cas_afficherBDD) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__3B) COMMA_HERE) ;
          } break ;
        case 13 : {
          ...
          GGS_luint  var_cas_afficherBDD ;
          var_cas_afficherBDD = GGS_luint ::constructor_new (_inLexique, GGS_uint (3U), GGS_location (_inLexique) COMMA_HERE) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__23) COMMA_HERE) ;
          nt_analyserFormule_ (_inLexique, var_cas_tableFormules, var_cas_ioDomainMap, var_cas_listeCalculs, var_cas_afficherBDD) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__3B) COMMA_HERE) ;
          } break ;
        case 14 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__23) COMMA_HERE) ;
          GGS_luint  var_cas_afficherBDD ;
          var_cas_afficherBDD = GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) ;
          nt_analyserFormule_ (_inLexique, var_cas_tableFormules, var_cas_ioDomainMap, var_cas_listeCalculs, var_cas_afficherBDD) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__3B) COMMA_HERE) ;
          } break ;
        default :
...
void syntaxeBDD::
pr_domainDefinition_syntaxeBDD_222_23_ (lexiqueBDD & _inLexique,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
  ...
  switch (select_syntaxeBDD_1 (_inLexique)) {
    case 1 : {
      ...
      switch (select_syntaxeBDD_2 (_inLexique)) {
        ...
        case 2 : {
          ...
          var_cas_lowBound = GGS_luint ::constructor_new (_inLexique, GGS_uint (0U), GGS_location (_inLexique) COMMA_HERE) ;
          switch (select_syntaxeBDD_3 (_inLexique)) {
            case 1 : {
              var_cas_highBound = GGS_luint ::constructor_new (_inLexique, GGS_uint (1U), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 2 : {
    ...
    case 3 : {
      ...
      if (_temp_6537.isBuilt ()) {
        _temp_6537 (HERE)->method_searchKey (_inLexique, var_cas_domainName, var_cas_outDomain COMMA_SOURCE_FILE_AT_LINE (268)) ;
      }
      } break ;
    default :
      break ;
...
void syntaxeBDD::
pr_analyserFormule_syntaxeBDD_276_22_ (lexiqueBDD & _inLexique,
                                GGS_typeTableFormules  &var_cas_tableFormules,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeListeCalculs  &var_cas_listeCalculs,
                                GGS_luint  var_cas_afficherBDD) {
...
void syntaxeBDD::
pr_argsFormelsFormule_syntaxeBDD_311_25_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  &var_cas_tableVariables,
      ...
      { const GGS_typeDomain _var_9309 = operand_8446->mInfo.mDomain ; // CAST instruction
        if (_var_9309.getPtr () != NULL) {
          ...
          if (dynamic_cast <cPtr_typeDirectDomain *> (_var_9309.getPtr ()) != NULL) {
            ...
            var_cas_outMap.modifier_insertKey (_inLexique, operand_8446->mKey, var_cas_v COMMA_SOURCE_FILE_AT_LINE (348)) ;
            ...
            var_cas_outMap.modifier_insertKey (_inLexique, operand_8446->mKey, var_cas_v COMMA_SOURCE_FILE_AT_LINE (354)) ;
          }else{
            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("a aDomain was expected here ; I found "))._operator_concat (operand_8446->mInfo.mDomain.reader_messageDomainType (_inLexique COMMA_SOURCE_FILE_AT_LINE (356))) COMMA_SOURCE_FILE_AT_LINE (357)) ;
          }
        }
      }
    }
...
void syntaxeBDD::
pr_declarations_syntaxeBDD_363_19_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  &var_cas_tableVariables,
                                GGS_uint  &var_cas_ioBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeFormalArgumentsList  &var_cas_listeArgFormelsBool) {
            ...
            if (dynamic_cast <cPtr_typeDirectDomain *> (_var_11822.getPtr ()) != NULL) {
              ...
              { const GGS_typeVariableDescriptor _var_10351 = var_cas_v ; // CAST instruction
                if (_var_10351.getPtr () != NULL) {
                  ...
                  var_cas_nom._castDefaultErrorMessage (_inLexique, _castBranchDescriptor, 1, & typeid (* (_var_10351.getPtr ())) COMMA_SOURCE_FILE_AT_LINE (385)) ;
                  }
                }
              }
              ...
              var_cas_nom.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("a aDomain was expected here ; I found "))._operator_concat (var_cas_aDomain.reader_messageDomainType (_inLexique COMMA_SOURCE_FILE_AT_LINE (410))) COMMA_SOURCE_FILE_AT_LINE (411)) ;
            }
          }
        }
...
void syntaxeBDD::
pr_dimension_syntaxeBDD_421_16_ (lexiqueBDD & _inLexique,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeDomain  &var_cas_outDomain) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__3A) COMMA_HERE) ;
  switch (select_syntaxeBDD_7 (_inLexique)) {
    case 1 : {
      ...
      switch (select_syntaxeBDD_8 (_inLexique)) {
        case 1 : {
          var_cas_highBound = GGS_luint ::constructor_new (_inLexique, GGS_uint (1U), GGS_location (_inLexique) COMMA_HERE) ;
          var_cas_dim = GGS_luint ::constructor_new (_inLexique, GGS_uint (1U), GGS_location (_inLexique) COMMA_HERE) ;
          } break ;
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__5B) COMMA_HERE) ;
          _inLexique._assignFromAttribute_att_valeur (var_cas_dim) ;
    ...
    case 2 : {
      ...
      if (_temp_12627.isBuilt ()) {
        _temp_12627 (HERE)->method_searchKey (_inLexique, var_cas_domainName, var_cas_outDomain COMMA_SOURCE_FILE_AT_LINE (444)) ;
      }
      } break ;
    default :
      break ;
...
void syntaxeBDD::
pr_type_formule_syntaxeBDD_452_19_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
...
void syntaxeBDD::
pr_type_formule_syntaxeBDD_480_19_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
  ...
  var_cas_signe = GGS_lbool ::constructor_new (_inLexique, GGS_bool (true), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_luint  var_cas_numero ;
  GGS_extern_bdd var_cas_unusedBDD ;
  var_cas_unusedBDD = GGS_extern_bdd::constructor_empty (_inLexique COMMA_HERE) ;
...
void syntaxeBDD::
pr_type_formule_syntaxeBDD_509_19_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
  ...
  GGS_lbool  var_cas_signe ;
  var_cas_signe = GGS_lbool ::constructor_new (_inLexique, GGS_bool (false), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_luint  var_cas_numero ;
  GGS_extern_bdd var_cas_unusedBDD ;
  var_cas_unusedBDD = GGS_extern_bdd::constructor_empty (_inLexique COMMA_HERE) ;
...
void syntaxeBDD::
pr_formule_syntaxeBDD_541_14_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_egalite_formule_syntaxeBDD_588_22_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_terme_formule_syntaxeBDD_622_20_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_655_22_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_675_22_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  /* var_cas_tableVariables */,
                                GGS_uint  /* var_cas_inBDDslot */,
                                GGS_typeDomainMap  &/* var_cas_ioDomainMap */,
                                GGS_typeTableFormules  &/* var_cas_tableFormules */,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_688_22_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  /* var_cas_inBDDslot */,
                                GGS_typeDomainMap  &/* var_cas_ioDomainMap */,
                                GGS_typeTableFormules  &/* var_cas_tableFormules */,
...
void syntaxeBDD::
pr_comparaisonVariable_syntaxeBDD_714_26_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  /* var_cas_tableVariables */,
                                GGS_luint  var_cas_numero,
                                GGS_luint  var_cas_dim,
                                GGS_luint  var_cas_lowBound,
...
void syntaxeBDD::
pr_comparaisonVariable_syntaxeBDD_731_26_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_754_22_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  /* var_cas_tableVariables */,
                                GGS_uint  /* var_cas_inBDDslot */,
                                GGS_typeDomainMap  &/* var_cas_ioDomainMap */,
                                GGS_typeTableFormules  &/* var_cas_tableFormules */,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_767_22_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_788_22_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_828_22_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_862_22_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  var_cas_inBDDslot,
                                GGS_typeDomainMap  &var_cas_ioDomainMap,
                                GGS_typeTableFormules  &var_cas_tableFormules,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_893_22_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  /* var_cas_inBDDslot */,
                                GGS_typeDomainMap  &/* var_cas_ioDomainMap */,
                                GGS_typeTableFormules  &/* var_cas_tableFormules */,
...
void syntaxeBDD::
pr_facteur_formule_syntaxeBDD_912_22_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  var_cas_tableVariables,
                                GGS_uint  /* var_cas_inBDDslot */,
                                GGS_typeDomainMap  &/* var_cas_ioDomainMap */,
                                GGS_typeTableFormules  &var_cas_tableFormules,
  ...
  if (_temp_25014.isBuilt ()) {
    _temp_25014 (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_nom, var_cas_numero, var_cas_listeArgsFormelsBool, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (924)) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (lexiqueBDD::lexiqueBDD_1__5B) COMMA_HERE) ;
        ...
        { const GGS_typeVariableDescriptor _var_25845 = var_cas_varDescriptor ; // CAST instruction
          if (_var_25845.getPtr () != NULL) {
            ...
            if (dynamic_cast <cPtr_typeDirectVariable *> (_var_25845.getPtr ()) != NULL) {
              ...
              ::routine_buildActualArgsList (_inLexique,  var_cas_rv.reader_mMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (935)),  var_cas_listeArgsEffectifsBool,  var_cas_errorLocation COMMA_SOURCE_FILE_AT_LINE (935)) ;
            }else{
              var_cas_errorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("a variable was expected here ; I found "))._operator_concat (var_cas_varDescriptor.reader_variableDescriptorErrorMessage (_inLexique COMMA_SOURCE_FILE_AT_LINE (938))) COMMA_SOURCE_FILE_AT_LINE (939)) ;
            }
          }
        }
  ...
  var_cas_unusedBool = GGS_lbool ::constructor_new (_inLexique, GGS_bool (false), GGS_location (_inLexique) COMMA_HERE) ;
...
void syntaxeBDD::
pr_parse_argument_syntaxeBDD_954_21_ (lexiqueBDD & _inLexique,
  ...
  if (_temp_26568.isBuilt ()) {
    _temp_26568 (HERE)->method_searchKey (_inLexique, var_cas_varName, var_cas_outVarDescriptor COMMA_SOURCE_FILE_AT_LINE (962)) ;
  }
      ...
      switch (select_repeat_syntaxeBDD_13 (_inLexique)) {
        case 2 : {
          ...
          if (_temp_27051.isBuilt ()) {
            _temp_27051 (HERE)->method_searchKey (_inLexique, var_cas_fieldName, var_cas_outVarDescriptor COMMA_SOURCE_FILE_AT_LINE (974)) ;
          }
          } break ;
        default :
...
void syntaxeBDD::
pr_parse_scalar_argument_syntaxeBDD_980_28_ (lexiqueBDD & _inLexique,
                                GGS_typeTableVariablesBool  &var_cas_ioVarMap,
