...
#define macro_typeFormuleQuelqueSoit

#define macroInheritFrom_typeFormuleQuelqueSoit

class cPtr_typeFormuleQuelqueSoit : public cPtr_typeFormule {
  private : typedef cPtr_typeFormule inherited ;
  macroInheritFrom_typeFormule
  macro_typeFormuleQuelqueSoit
  public : cPtr_typeFormuleQuelqueSoit (const GGS_typeFormalArgumentsList & ,
                                const GGS_typeFormule & ,
                                const GGS_bdd& ) ;
...
class GGS_typeFormuleQuelqueSoit {
  #ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
    public : static cPtr_typeFormuleQuelqueSoit * constructor_new (const GGS_typeFormalArgumentsList & argument_0,
                                const GGS_typeFormule & argument_1,
                                const GGS_bdd& argument_2) ;
  #else
    public : inline static cPtr_typeFormuleQuelqueSoit * constructor_new (const GGS_typeFormalArgumentsList & argument_0,
                                const GGS_typeFormule & argument_1,
                                const GGS_bdd& argument_2) {
      return new cPtr_typeFormuleQuelqueSoit(argument_0,
                                argument_1,
                                argument_2) ;
    }
  #endif
...
#define macro_typeDimensionnerCache

#define macroInheritFrom_typeDimensionnerCache

class cPtr_typeDimensionnerCache : public cPtr_typeCalcul {
  private : typedef cPtr_typeCalcul inherited ;
  macroInheritFrom_typeCalcul
  macro_typeDimensionnerCache
  public : cPtr_typeDimensionnerCache (const GGS_luint & ) ;
...
class GGS_typeDimensionnerCache {
  #ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
    public : static cPtr_typeDimensionnerCache * constructor_new (const GGS_luint & argument_0) ;
  #else
    public : inline static cPtr_typeDimensionnerCache * constructor_new (const GGS_luint & argument_0) {
      return new cPtr_typeDimensionnerCache(argument_0) ;
    }
  #endif
} ;
