...
lexiqueBDD::
lexiqueBDD (AC_galgas_io * inGalgasInputOutput COMMA_LOCATION_ARGS)
...
C_String lexiqueBDD::
getCurrentTokenString (const sint16 inTokenCode) const {
  C_String s ;
  switch (inTokenCode) {
  case  lexiqueBDD_1_:
    s << "$$" ;
  ...
  while (currentTokenCode_ < 0) {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        loop_ = true ;
        currentTokenCode_ = search_into_motsReservesKerBDD (att_idf) ;
        if (currentTokenCode_ == -1) {
          currentTokenCode_ = lexiqueBDD_1_id ;
        }
        _enterToken (currentTokenCode_) ;
        ...
        loop_ = true ;
        if (testForInputChar ('\"')) {
          currentTokenCode_ = lexiqueBDD_1_string ;
          _enterToken (lexiqueBDD_1_string) ;
        }else{
          lexicalError (gErrorMessage_2 COMMA_LINE_AND_SOURCE_FILE) ;
        }
      }else if (testForInputChar ('0', '9')) {
        scanner_action_enterDigitIntoUlong (att_valeur, previousChar (), gErrorMessage_0, gErrorMessage_1) ;
        do {
        ...
        loop_ = true ;
        currentTokenCode_ = lexiqueBDD_1_nombre ;
        _enterToken (lexiqueBDD_1_nombre) ;
      }else if (testForInputString (":=", 2)) {
        currentTokenCode_ = lexiqueBDD_1__3A_3D ;
        _enterToken (lexiqueBDD_1__3A_3D) ;
      }else if (testForInputString ("..", 2)) {
        currentTokenCode_ = lexiqueBDD_1__2E_2E ;
        _enterToken (lexiqueBDD_1__2E_2E) ;
      }else if (testForInputString ("+=", 2)) {
        currentTokenCode_ = lexiqueBDD_1__2B_3D ;
        _enterToken (lexiqueBDD_1__2B_3D) ;
      }else if (testForInputString ("-=", 2)) {
        currentTokenCode_ = lexiqueBDD_1__2D_3D ;
        _enterToken (lexiqueBDD_1__2D_3D) ;
      }else if (testForInputString ("->", 2)) {
        currentTokenCode_ = lexiqueBDD_1__2D_3E ;
        _enterToken (lexiqueBDD_1__2D_3E) ;
      }else if (testForInputString ("(", 1)) {
        currentTokenCode_ = lexiqueBDD_1__28 ;
        _enterToken (lexiqueBDD_1__28) ;
      }else if (testForInputString (")", 1)) {
        currentTokenCode_ = lexiqueBDD_1__29 ;
        _enterToken (lexiqueBDD_1__29) ;
      }else if (testForInputString ("{", 1)) {
        currentTokenCode_ = lexiqueBDD_1__7B ;
        _enterToken (lexiqueBDD_1__7B) ;
      }else if (testForInputString ("}", 1)) {
        currentTokenCode_ = lexiqueBDD_1__7D ;
        _enterToken (lexiqueBDD_1__7D) ;
      }else if (testForInputString ("[", 1)) {
        currentTokenCode_ = lexiqueBDD_1__5B ;
        _enterToken (lexiqueBDD_1__5B) ;
      }else if (testForInputString ("]", 1)) {
        currentTokenCode_ = lexiqueBDD_1__5D ;
        _enterToken (lexiqueBDD_1__5D) ;
      }else if (testForInputString (":", 1)) {
        currentTokenCode_ = lexiqueBDD_1__3A ;
        _enterToken (lexiqueBDD_1__3A) ;
      }else if (testForInputString (".", 1)) {
        currentTokenCode_ = lexiqueBDD_1__2E ;
        _enterToken (lexiqueBDD_1__2E) ;
      }else if (testForInputString ("&", 1)) {
        currentTokenCode_ = lexiqueBDD_1__26 ;
        _enterToken (lexiqueBDD_1__26) ;
      }else if (testForInputString ("|", 1)) {
        currentTokenCode_ = lexiqueBDD_1__7C ;
        _enterToken (lexiqueBDD_1__7C) ;
      }else if (testForInputString ("~", 1)) {
        currentTokenCode_ = lexiqueBDD_1__7E ;
        _enterToken (lexiqueBDD_1__7E) ;
      }else if (testForInputString (",", 1)) {
        currentTokenCode_ = lexiqueBDD_1__2C ;
        _enterToken (lexiqueBDD_1__2C) ;
      }else if (testForInputString ("\?", 1)) {
        currentTokenCode_ = lexiqueBDD_1__3F ;
        _enterToken (lexiqueBDD_1__3F) ;
      }else if (testForInputString ("!", 1)) {
        currentTokenCode_ = lexiqueBDD_1__21 ;
        _enterToken (lexiqueBDD_1__21) ;
      }else if (testForInputString (";", 1)) {
        currentTokenCode_ = lexiqueBDD_1__3B ;
        _enterToken (lexiqueBDD_1__3B) ;
      }else if (testForInputString ("#", 1)) {
        currentTokenCode_ = lexiqueBDD_1__23 ;
        _enterToken (lexiqueBDD_1__23) ;
      }else if (testForInputChar ('=')) {
        scanner_action_formerCompEgal (att_valeur) ;
        currentTokenCode_ = lexiqueBDD_1_comp ;
        _enterToken (lexiqueBDD_1_comp) ;
      }else if (testForInputChar ('<')) {
        if (testForInputChar ('>')) {
        ...
        currentTokenCode_ = lexiqueBDD_1_ ; // Empty string code
...
void lexiqueBDD::_enterToken (const sint16 inTokenCode) {
  cTokenFor_lexiqueBDD * _p = NULL ;
  macroMyNew (_p, cTokenFor_lexiqueBDD ()) ;
  _p->_mTokenCode = inTokenCode ;
  _p->_mCurrentLocation = currentLocationInSource () ;
  _p->att_idf = att_idf ;
  _p->att_token = att_token ;
  _p->att_valeur = att_valeur ;
