...
#include "opComp.h" // Generated by 'include "..."'
...
//--- Syntax error message for terminal '$cache$' :
static const char * gSyntaxErrorMessage_cache = "the 'cache' keyword" ;
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [44] = {"end of source",
...
const sint16 lexiqueBDD::lexiqueBDD_table_size_motsReservesKerBDD = 17 ;

const C_lexique_table_entry lexiqueBDD::lexiqueBDD_table_for_motsReservesKerBDD [17] = {
  ...
  C_lexique_table_entry ("cache", 5, lexiqueBDD_1_cache),
  ...
  while (mCurrentTokenCode < 0) {
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        formerCompEgal (att_valeur, * this) ;
        mCurrentTokenCode = lexiqueBDD_1_comp ;
      }else if (testForInputChar ('<')) {
        if (testForInputChar ('>')) {
          formerCompNonEgal (att_valeur, * this) ;
          mCurrentTokenCode = lexiqueBDD_1_comp ;
        }else if (testForInputChar ('=')) {
          formerCompInfEgal (att_valeur, * this) ;
          mCurrentTokenCode = lexiqueBDD_1_comp ;
        }else{
          formerCompInf (att_valeur, * this) ;
          mCurrentTokenCode = lexiqueBDD_1_comp ;
        }
      }else if (testForInputChar ('>')) {
        if (testForInputChar ('=')) {
          formerCompSupEgal (att_valeur, * this) ;
          mCurrentTokenCode = lexiqueBDD_1_comp ;
        }else{
          formerCompSup (att_valeur, * this) ;
          mCurrentTokenCode = lexiqueBDD_1_comp ;
        }
      }else if (testForInputChar ('$')) {
        do {
          if (testForInputChar (((char) 0x1), '\t') ||
              testForInputChar ('\v') ||
              testForInputChar ('\f') ||
              testForInputChar (((char) 0xE), ((char) 0xFF))) {
          }else{
            loop_ = false ;
          }
        }while (loop_) ;
...
getTerminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [44] = {0,
    0 /* lexiqueBDD_1_nombre */,
    0 /* lexiqueBDD_1_id */,
    0 /* lexiqueBDD_1_string */,
    0 /* lexiqueBDD_1_comp */,
    0 /* lexiqueBDD_1__28 */,
    0 /* lexiqueBDD_1__29 */,
    0 /* lexiqueBDD_1__7B */,
    ...
    0 /* lexiqueBDD_1__5B */,
    0 /* lexiqueBDD_1__5D */,
    0 /* lexiqueBDD_1__3A_3D */,
    0 /* lexiqueBDD_1__3A */,
    0 /* lexiqueBDD_1__2E */,
    0 /* lexiqueBDD_1__2E_2E */,
    0 /* lexiqueBDD_1__3A_3A */,
    0 /* lexiqueBDD_1__2B_3D */,
    0 /* lexiqueBDD_1__2D_3D */,
    0 /* lexiqueBDD_1__2D_3E */,
    0 /* lexiqueBDD_1__26 */,
    0 /* lexiqueBDD_1__7C */,
    0 /* lexiqueBDD_1__7E */,
    0 /* lexiqueBDD_1__2C */,
    ...
    0 /* lexiqueBDD_1__3B */,
    0 /* lexiqueBDD_1__23 */,
    0 /* lexiqueBDD_1_cache */,
    0 /* lexiqueBDD_1_map */,
    0 /* lexiqueBDD_1_bdd */,
    0 /* lexiqueBDD_1_domain */,
    0 /* lexiqueBDD_1_bool */,
    0 /* lexiqueBDD_1_record */,
    0 /* lexiqueBDD_1_true */,
    0 /* lexiqueBDD_1_false */,
    0 /* lexiqueBDD_1_display */,
    0 /* lexiqueBDD_1_include */,
    0 /* lexiqueBDD_1_dump */,
    0 /* lexiqueBDD_1_verify */,
    0 /* lexiqueBDD_1_end */,
    0 /* lexiqueBDD_1_if */,
    0 /* lexiqueBDD_1_then */,
    0 /* lexiqueBDD_1_else */,
    0 /* lexiqueBDD_1_dimension */
  } ;
