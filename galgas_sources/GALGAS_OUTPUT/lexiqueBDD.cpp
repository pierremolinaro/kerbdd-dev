...
//                    february 24th, 2010, at 19h58'36"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_lstring * C_Lexique_lexiqueBDD::synthetizedAttribute_att_5F_idf (void) const {
  cTokenFor_lexiqueBDD * ptr = (cTokenFor_lexiqueBDD *) mCurrentTokenPtr ;
  ...
  GALGAS_string * value = GALGAS_string::constructor_new (ptr->mLexicalAttribute_att_5F_idf COMMA_HERE) ;
  return GALGAS_lstring::constructor_new (value, currentLocation COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring * C_Lexique_lexiqueBDD::synthetizedAttribute_att_5F_token (void) const {
  cTokenFor_lexiqueBDD * ptr = (cTokenFor_lexiqueBDD *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_lexiqueBDD) ;
  GALGAS_location * currentLocation = GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE) ;
...
GALGAS_luint * C_Lexique_lexiqueBDD::synthetizedAttribute_att_5F_valeur (void) const {
  cTokenFor_lexiqueBDD * ptr = (cTokenFor_lexiqueBDD *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_lexiqueBDD) ;
  GALGAS_location * currentLocation = GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE) ;
  GALGAS_uint * value = GALGAS_uint::constructor_new (ptr->mLexicalAttribute_att_5F_valeur COMMA_HERE) ;
