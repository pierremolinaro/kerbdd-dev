...
//                    february 10th, 2005, at 21h51'45"                      *
//                                                                           *
...
parseLexicalToken (const bool inPropagateLexicaleErrorException) {
  ...
  while (mCurrentTokenCode < 0) {
    ...
    try{
      ...
      }else if (testForInputChar (34)) {
        do {
          if (testForInputChar (32) ||
              testForInputChar (33) ||
              testForInputChar (35, 255)) {
            enterCharacterIntoString (att_token, getPreviousChar (), * this) ;
          }else{
            loop_ = false ;
          }
      ...
      }else if (testForInputChar (61)) {
        formerCompEgal (att_valeur, * this) ;
        mCurrentTokenCode = lexiqueBDD_1_comp ;
      }else if (testForInputChar (60)) {
        if (testForInputChar (62)) {
      ...
      }else if (testForInputChar (62)) {
        if (testForInputChar (61)) {
      ...
      }else if (testForInputChar (36)) {
        do {
          if (testForInputChar (1, 9) ||
              testForInputChar (11) ||
              testForInputChar (12) ||
              testForInputChar (14, 255)) {
          }else{
            loop_ = false ;
          }
        }while (loop_) ;
