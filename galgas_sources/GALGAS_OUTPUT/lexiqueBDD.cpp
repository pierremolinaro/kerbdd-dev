...
mLexicalAttribute_att_5F_idf (),
mLexicalAttribute_att_5F_token (),
mLexicalAttribute_att_5F_valeur () {
}
...
C_String C_Lexique_lexiqueBDD::getCurrentTokenString (const cToken * inTokenPtr) const {
  ...
  if (ptr == NULL) {
    ...
    case kToken_nombre:
      ...
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      s.appendUnicodeCharacter (TO_UNICODE (' ') COMMA_HERE) ;
      s.appendUnsigned (ptr->mLexicalAttribute_att_5F_valeur) ;
      break ;
    case kToken_id:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      s.appendCString ("id") ;
...
bool C_Lexique_lexiqueBDD::parseLexicalToken (void) {
  ...
  while ((token.mTokenCode < 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
    token.mLexicalAttribute_att_5F_idf.setLengthToZero () ;
    token.mLexicalAttribute_att_5F_token.setLengthToZero () ;
    token.mLexicalAttribute_att_5F_valeur = 0 ;
    mTokenFirstLocation = mCurrentLocation ;
    try{
      if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) || testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('Z'))) {
        do {
          ::scanner_routine_enterCharacterIntoString (*this, token.mLexicalAttribute_att_5F_idf, ::scanner_function_toLower (*this, previousChar ())) ;
        ...
        if (token.mTokenCode == -1) {
          token.mTokenCode = search_into_motsReservesKerBDD (token.mLexicalAttribute_att_5F_idf) ;
        }
        if (token.mTokenCode == -1) {
        ...
        ::scanner_routine_enterDigitIntoUInt (*this, previousChar (), token.mLexicalAttribute_att_5F_valeur, gLexicalMessage_nombre_dec_trop_grand, gLexicalMessage_car_non_chiffre) ;
        do {
        ...
        ::scanner_routine_formerCompEgal (*this, token.mLexicalAttribute_att_5F_valeur) ;
        token.mTokenCode = kToken_comp ;
        enterToken (token) ;
      }else if (testForInputUTF32Char (TO_UNICODE ('<'))) {
        if (testForInputUTF32Char (TO_UNICODE ('>'))) {
          ::scanner_routine_formerCompNonEgal (*this, token.mLexicalAttribute_att_5F_valeur) ;
          token.mTokenCode = kToken_comp ;
          enterToken (token) ;
        }else if (testForInputUTF32Char (TO_UNICODE ('='))) {
          ::scanner_routine_formerCompInfEgal (*this, token.mLexicalAttribute_att_5F_valeur) ;
          token.mTokenCode = kToken_comp ;
          enterToken (token) ;
        }else{
          ::scanner_routine_formerCompInf (*this, token.mLexicalAttribute_att_5F_valeur) ;
          token.mTokenCode = kToken_comp ;
          enterToken (token) ;
        }
      }else if (testForInputUTF32Char (TO_UNICODE ('>'))) {
        if (testForInputUTF32Char (TO_UNICODE ('='))) {
          ::scanner_routine_formerCompSupEgal (*this, token.mLexicalAttribute_att_5F_valeur) ;
          token.mTokenCode = kToken_comp ;
          enterToken (token) ;
        }else{
          ::scanner_routine_formerCompSup (*this, token.mLexicalAttribute_att_5F_valeur) ;
          token.mTokenCode = kToken_comp ;
          enterToken (token) ;
        }
      }else if (testForInputUTF32Char (TO_UNICODE ('$'))) {
...
void C_Lexique_lexiqueBDD::enterToken (const cTokenFor_lexiqueBDD & inToken) {
  ...
  ptr->mLexicalAttribute_att_5F_idf = inToken.mLexicalAttribute_att_5F_idf ;
  ptr->mLexicalAttribute_att_5F_token = inToken.mLexicalAttribute_att_5F_token ;
  ptr->mLexicalAttribute_att_5F_valeur = inToken.mLexicalAttribute_att_5F_valeur ;
...
C_String C_Lexique_lexiqueBDD::attributeValue_att_5F_idf (void) const {
  cTokenFor_lexiqueBDD * ptr = (cTokenFor_lexiqueBDD *) mCurrentTokenPtr ;
  return ptr->mLexicalAttribute_att_5F_idf ;
}

//---------------------------------------------------------------------------*

C_String C_Lexique_lexiqueBDD::attributeValue_att_5F_token (void) const {
  cTokenFor_lexiqueBDD * ptr = (cTokenFor_lexiqueBDD *) mCurrentTokenPtr ;
...
PMUInt32 C_Lexique_lexiqueBDD::attributeValue_att_5F_valeur (void) const {
  cTokenFor_lexiqueBDD * ptr = (cTokenFor_lexiqueBDD *) mCurrentTokenPtr ;
  return ptr->mLexicalAttribute_att_5F_valeur ;
}
...
void C_Lexique_lexiqueBDD::assignFromAttribute_att_5F_idf (GGS_lstring & outValue) const {
  cTokenFor_lexiqueBDD * ptr = (cTokenFor_lexiqueBDD *) mCurrentTokenPtr ;
  outValue = GGS_lstring (* this, ptr->mLexicalAttribute_att_5F_idf) ;
}

//---------------------------------------------------------------------------*

void C_Lexique_lexiqueBDD::assignFromAttribute_att_5F_token (GGS_lstring & outValue) const {
  cTokenFor_lexiqueBDD * ptr = (cTokenFor_lexiqueBDD *) mCurrentTokenPtr ;
...
void C_Lexique_lexiqueBDD::assignFromAttribute_att_5F_valeur (GGS_luint & outValue) const {
  cTokenFor_lexiqueBDD * ptr = (cTokenFor_lexiqueBDD *) mCurrentTokenPtr ;
  outValue = GGS_luint (* this, ptr->mLexicalAttribute_att_5F_valeur) ;
}
...
GALGASap_lstring C_Lexique_lexiqueBDD::synthetizedAttribute_att_5F_idf (void) const {
  cTokenFor_lexiqueBDD * ptr = (cTokenFor_lexiqueBDD *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_lexiqueBDD) ;
  ...
  GALGASap_string value (GALGAS_string::constructor_new (ptr->mLexicalAttribute_att_5F_idf COMMA_HERE)) ;
...
GALGASap_lstring C_Lexique_lexiqueBDD::synthetizedAttribute_att_5F_token (void) const {
  cTokenFor_lexiqueBDD * ptr = (cTokenFor_lexiqueBDD *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_lexiqueBDD) ;
  GALGASap_location currentLocation (GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
  GALGASap_string value (GALGAS_string::constructor_new (ptr->mLexicalAttribute_att_5F_token COMMA_HERE)) ;
  GALGASap_lstring result (GALGAS_lstring::constructor_new (value, currentLocation COMMA_HERE)) ;
  return result ;
}
...
GALGASap_luint C_Lexique_lexiqueBDD::synthetizedAttribute_att_5F_valeur (void) const {
  cTokenFor_lexiqueBDD * ptr = (cTokenFor_lexiqueBDD *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_lexiqueBDD) ;
  GALGASap_location currentLocation (GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
  GALGASap_uint value (GALGAS_uint::constructor_new (ptr->mLexicalAttribute_att_5F_valeur COMMA_HERE)) ;
