...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [47] = {"end of source",
    ...
    try{
      if (testForInputChar ('a', 'z') ||
        ...
        if (testForInputChar ('\"')) {
          ...
          lexicalError (gErrorMessage_2 LINE_AND_SOURCE_FILE) ;
        }
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [47] = {0,
