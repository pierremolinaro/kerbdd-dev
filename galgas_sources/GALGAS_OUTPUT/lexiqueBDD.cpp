...
GALGASap_lstring C_Lexique_lexiqueBDD::synthetizedAttribute_att_5F_idf (void) const {
  ...
  GALGASap_string value (GALGASap_string::constructor_new (ptr->mLexicalAttribute_att_5F_idf COMMA_HERE)) ;
...
GALGASap_luint C_Lexique_lexiqueBDD::synthetizedAttribute_att_5F_valeur (void) const {
  ...
  macroValidObject (ptr, cTokenFor_lexiqueBDD) ;
  GALGASap_location currentLocation (GALGASap_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
  GALGASap_uint value (GALGASap_uint::constructor_new (ptr->mLexicalAttribute_att_5F_valeur COMMA_HERE)) ;
