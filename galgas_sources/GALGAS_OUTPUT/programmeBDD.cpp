...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "programmeBDD.gProgram", line
...
static void
programmeBDD_prologue (C_Compiler & /* inLexique */,
...
static void
programmeBDD_epilogue (C_Compiler & /* inLexique */,
                     const TC_UniqueArray <C_String> & /* inSourceFilesArray */) {
}
...
//--- Fix parameters for BDD package
  ...
  //--- Enable 64 bit alloc debug ? Only if compiled in 64 bit and in debug mode
    ...
    try{
      ...
      programmeBDD_prologue (* _commonLexique, sourceFilesArray) ;
      for (PMSInt32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("bdd") == 0) {
            ...
            GGS_typeTableFormules  var_cas_tableFormules = GGS_typeTableFormules ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (11)) ;
            GGS_typeListeCalculs  var_cas_listeCalculs = GGS_typeListeCalculs ::constructor_emptyList () ;
            GGS_typeDomainMap  var_cas_domainMap = GGS_typeDomainMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (13)) ;
            ...
            if (var_cas_tableFormules.isBuilt () &&
                var_cas_listeCalculs.isBuilt () &&
                var_cas_domainMap.isBuilt ()) {
              ::routine_generate_code (inLexique,  var_cas_tableFormules,  var_cas_listeCalculs,  var_cas_domainMap COMMA_SOURCE_FILE_AT_LINE (19)) ;
            }
            if (verboseOptionOn) {
    ...
    //--- Epilogue
      programmeBDD_epilogue (* _commonLexique, sourceFilesArray) ;
