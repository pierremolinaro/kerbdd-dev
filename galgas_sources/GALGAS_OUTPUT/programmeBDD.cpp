        ...
        if (fileExtension.compare ("bdd") == 0) {
          ...
          { lexiqueBDD * scanner_ = NULL ;
            ...
            try{
              ...
              var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () SOURCE_FILE_AT_LINE (14)) ;
            }
          ...
          if (var_cas_tableFormules._isBuilt () &&
            ...
            ::routine_generate_code (_inLexique,  var_cas_tableFormules,  var_cas_listeCalculs,  var_cas_domainMap SOURCE_FILE_AT_LINE (19)) ;
          }
