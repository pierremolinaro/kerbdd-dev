      ...
      for (PMSInt32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("bdd") == 0) {
            ...
            GGS_typeTableFormules  var_cas_tableFormules = GGS_typeTableFormules ::constructor_emptyMap (inLexique COMMA_HERE) ;
            GGS_typeListeCalculs  var_cas_listeCalculs = GGS_typeListeCalculs ::constructor_emptyList () ;
            GGS_typeDomainMap  var_cas_domainMap = GGS_typeDomainMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
