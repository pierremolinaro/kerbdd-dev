      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("bdd") == 0) {
            ...
            var_cas_tableFormules = GGS_typeTableFormules ::constructor_emptyMap (inLexique COMMA_HERE) ;
            ...
            var_cas_domainMap = GGS_typeDomainMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
