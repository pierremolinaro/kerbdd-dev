...
grammar_programmeBDD (C_galgas_io * inParametersPtr
                  COMMA_LOCATION_ARGS) :
_mScannerPtr (NULL) {
  macroMyNew (_mScannerPtr, lexiqueBDD (inParametersPtr COMMA_THERE)) ;
}
    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("bdd") == 0) {
          ...
          macroMyNew (compiler, grammar_programmeBDD (galgasIOptr COMMA_HERE)) ;
          compiler->_prologue () ;
